...
$credential = New-Object System.Management.Automation.PSCredential "$DomainName\$AdminUser", $SecurePwd -ErrorAction Stop
$DomainNameNetBios = $DomainName.Split('.')[0].ToUpper()
		
$promoteResult = Install-ADDSDomainController -DomainName $DomainName  `
	-Credential $credential -ReadOnlyReplica `
