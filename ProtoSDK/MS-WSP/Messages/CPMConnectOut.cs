...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.WSP
{
    ...
    public struct CPMConnectOut : IWspOutMessage
    {
        ...
        public void FromBytes(WspBuffer buffer)
        {
            ...
            _serverVersion = buffer.ToStruct<UInt32>();
            ...
            if (supportVersion)
            {
                ...
                dwWinVerMajor = buffer.ToStruct<UInt32>();

                dwWinVerMinor = buffer.ToStruct<UInt32>();

                dwNLSVerMajor = buffer.ToStruct<UInt32>();

                dwNLSVerMinor = buffer.ToStruct<UInt32>();
            }
            else
            {
