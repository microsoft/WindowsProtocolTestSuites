...
{
    public class AdtsModifyResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.ModifyResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.ModifyResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}