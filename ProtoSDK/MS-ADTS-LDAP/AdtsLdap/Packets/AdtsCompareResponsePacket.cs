...
{
    public class AdtsCompareResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.CompareResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.CompareResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}