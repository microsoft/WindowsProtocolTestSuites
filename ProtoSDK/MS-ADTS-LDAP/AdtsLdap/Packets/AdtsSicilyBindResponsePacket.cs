...
{
    public class AdtsSicilyBindResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.SicilyBindResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.SicilyBindResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}