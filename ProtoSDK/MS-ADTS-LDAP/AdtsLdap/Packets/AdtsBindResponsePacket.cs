...
{
    public class AdtsBindResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.BindResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.BindResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}