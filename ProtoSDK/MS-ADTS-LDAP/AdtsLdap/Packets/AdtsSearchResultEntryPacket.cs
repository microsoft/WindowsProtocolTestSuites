...
{
    public class AdtsSearchResultEntryPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.SearchResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.SearchResultEntry)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}