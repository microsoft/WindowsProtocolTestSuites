...
{
    public class AdtsBindRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.BindRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.BindRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}