...
{
    public class AdtsUnbindRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.UnbindRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.UnbindRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}