...
{
    public class AdtsAbandonRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.AbandonRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.AbandonRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}