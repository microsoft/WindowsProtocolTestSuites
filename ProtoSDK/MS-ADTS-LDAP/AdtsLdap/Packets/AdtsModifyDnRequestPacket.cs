...
{
    public class AdtsModifyDnRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.ModifyDNRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.ModifyDNRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}