...
{
    public class AdtsAddRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.AddRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.AddRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}