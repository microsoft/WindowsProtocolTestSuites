...
{
    public class AdtsSearchResultDonePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                // LDAP v2 doesn't have such message.
                return null;
            }
            else
            {
                return (LdapV3.SearchResultDone)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}