...
{
    public class AdtsModifyDnResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.ModifyDNResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.ModifyDNResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}