...
{
    public class AdtsModifyRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.ModifyRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.ModifyRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}