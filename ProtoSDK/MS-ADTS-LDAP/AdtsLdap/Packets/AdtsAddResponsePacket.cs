...
{
    public class AdtsAddResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.AddResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.AddResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}