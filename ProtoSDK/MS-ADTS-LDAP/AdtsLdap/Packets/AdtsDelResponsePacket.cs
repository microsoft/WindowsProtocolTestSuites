...
{
    public class AdtsDelResponsePacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.DelResponse)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.DelResponse)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}