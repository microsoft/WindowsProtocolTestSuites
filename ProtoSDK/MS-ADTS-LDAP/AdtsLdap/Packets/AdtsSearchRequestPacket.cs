...
{
    public class AdtsSearchRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.SearchRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.SearchRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}