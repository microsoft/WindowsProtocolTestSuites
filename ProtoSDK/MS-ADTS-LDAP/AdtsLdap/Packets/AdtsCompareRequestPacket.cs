...
{
    public class AdtsCompareRequestPacket : AdtsLdapPacket
    {
        /// <summary>
        ...
        public override Asn1Object GetInnerRequestOrResponse()
        {
            ...
            {
                return (LdapV2.CompareRequest)this.ldapMessagev2.protocolOp.GetData();
            }
            else
            {
                return (LdapV3.CompareRequest)this.ldapMessagev3.protocolOp.GetData();
            }
        }
    }
}