...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbFindNotifyCloseResponsePacket : SmbSingleResponsePacket 
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbFindNotifyCloseResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbFindNotifyCloseResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbFindNotifyCloseResponsePacket(SmbFindNotifyCloseResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbFindNotifyCloseResponsePacket(this);
        }
