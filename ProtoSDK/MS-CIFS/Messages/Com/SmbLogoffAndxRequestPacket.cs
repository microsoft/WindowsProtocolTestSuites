...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbLogoffAndxRequestPacket : SmbBatchedRequestPacket
    {
        #region Fields

        private SMB_COM_LOGOFF_ANDX_Request_SMB_Parameters smbParameters;
        private SMB_COM_LOGOFF_ANDX_Request_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_LOGOFF_ANDX_Request_SMB_Parameters
        /// </summary>
        public SMB_COM_LOGOFF_ANDX_Request_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_LOGOFF_ANDX_Request_SMB_Data
        /// </summary>
        public SMB_COM_LOGOFF_ANDX_Request_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        {
            return new SmbLogoffAndxRequestPacket(this);
        }
        ...
        {
            this.smbParameters = TypeMarshal.ToStruct<SMB_COM_LOGOFF_ANDX_Request_SMB_Parameters>(
        ...
        {
            this.smbData = TypeMarshal.ToStruct<SMB_COM_LOGOFF_ANDX_Request_SMB_Data>(
