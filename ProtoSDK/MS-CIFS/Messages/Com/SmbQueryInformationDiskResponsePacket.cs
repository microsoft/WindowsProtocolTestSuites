...
{
    /// <summary>
    /// Packets for SmbQueryInformationDisk Response
    /// </summary>
    public class SmbQueryInformationDiskResponsePacket : SmbSingleResponsePacket 
    {
        #region Fields

        private SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Parameters smbParameters;
        private SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Parameters
        /// </summary>
        public SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Data
        /// </summary>
        public SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        /// </summary>
        public SmbQueryInformationDiskResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbQueryInformationDiskResponsePacket(this);
        }
        ...
        protected override void DecodeParameters()
        {
            ...
            {
                this.smbParameters = TypeMarshal.ToStruct<SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Parameters>(
        ...
        {
            this.smbData = TypeMarshal.ToStruct<SMB_COM_QUERY_INFORMATION_DISK_Response_SMB_Data>(
