...
{
    /// <summary>
    /// Packets for SmbIoctlSecondary Request
    /// </summary>
    public class SmbIoctlSecondaryRequestPacket : SmbSingleRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbIoctlSecondaryRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbIoctlSecondaryRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbIoctlSecondaryRequestPacket(SmbIoctlSecondaryRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbIoctlSecondaryRequestPacket(this);
        }
