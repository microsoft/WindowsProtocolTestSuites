...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbWriteAndxResponsePacket : SmbBatchedResponsePacket
    {
        #region Fields

        private SMB_COM_WRITE_ANDX_Response_SMB_Parameters smbParameters;
        private SMB_COM_WRITE_ANDX_Response_SMB_Data smbData;
        ...
        /// </summary>
        public SMB_COM_WRITE_ANDX_Response_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_WRITE_ANDX_Response_SMB_Data
        /// </summary>
        public SMB_COM_WRITE_ANDX_Response_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        {
            return new SmbWriteAndxResponsePacket(this);
        }


        /// <summary>
        /// Encode the struct of SMB_COM_WRITE_ANDX_Response_SMB_Parameters into the struct of SmbParameters
        /// </summary>
        protected override void EncodeParameters()
        {
            this.smbParametersBlock = TypeMarshal.ToStruct<SmbParameters>(
                CifsMessageUtils.ToBytes<SMB_COM_WRITE_ANDX_Response_SMB_Parameters>(this.smbParameters));
        }


        /// <summary>
        /// Encode the struct of SMB_COM_WRITE_ANDX_Response_SMB_Data into the struct of SmbData
        /// </summary>
        protected override void EncodeData()
        {
            this.smbDataBlock = TypeMarshal.ToStruct<SmbData>(
                CifsMessageUtils.ToBytes<SMB_COM_WRITE_ANDX_Response_SMB_Data>(this.SmbData));
        }
        ...
        {
            this.smbData = TypeMarshal.ToStruct<SMB_COM_WRITE_ANDX_Response_SMB_Data>(
