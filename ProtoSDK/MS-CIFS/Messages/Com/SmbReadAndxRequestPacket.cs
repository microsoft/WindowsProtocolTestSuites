...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbReadAndxRequestPacket : SmbBatchedRequestPacket
    {
        #region Fields

        private SMB_COM_READ_ANDX_Request_SMB_Parameters smbParameters;
        private SMB_COM_READ_ANDX_Request_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_READ_ANDX_Request_SMB_Parameters
        /// </summary>
        public SMB_COM_READ_ANDX_Request_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_READ_ANDX_Request_SMB_Data
        /// </summary>
        public SMB_COM_READ_ANDX_Request_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
            ...
            : base(packet)
        {
            ...
            this.smbParameters.MaxNumberOfBytesToReturn = packet.SmbParameters.MaxNumberOfBytesToReturn;
            this.smbParameters.MinNumberOfBytesToReturn = packet.SmbParameters.MinNumberOfBytesToReturn;
        ...
        {
            return new SmbReadAndxRequestPacket(this);
        }


        /// <summary>
        /// Encode the struct of SMB_COM_READ_ANDX_Request_SMB_Parameters into the struct of SmbParameters
        /// </summary>
        protected override void EncodeParameters()
        {
            this.smbParametersBlock = TypeMarshal.ToStruct<SmbParameters>(
                CifsMessageUtils.ToBytes<SMB_COM_READ_ANDX_Request_SMB_Parameters>(this.smbParameters));
        }


        /// <summary>
        /// Encode the struct of SMB_COM_READ_ANDX_Request_SMB_Data into the struct of SmbData
        /// </summary>
        protected override void EncodeData()
        {
            this.smbDataBlock = TypeMarshal.ToStruct<SmbData>(
                CifsMessageUtils.ToBytes<SMB_COM_READ_ANDX_Request_SMB_Data>(this.SmbData));
        }
        ...
        {
            this.smbParameters = TypeMarshal.ToStruct<SMB_COM_READ_ANDX_Request_SMB_Parameters>(
        ...
        {
            this.smbData = TypeMarshal.ToStruct<SMB_COM_READ_ANDX_Request_SMB_Data>(
