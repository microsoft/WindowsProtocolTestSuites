...
{
    /// <summary>
    ///  Packets for SmbMove Request
    /// </summary>
    public class SmbMoveRequestPacket : SmbSingleRequestPacket
    {
        #region Fields
        ...
        /// </summary>
        public SmbMoveRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbMoveRequestPacket(SmbMoveRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbMoveRequestPacket(this);
        }
