...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbWriteBulkRequestPacket : SmbSingleRequestPacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbWriteBulkRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbWriteBulkRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbWriteBulkRequestPacket(SmbWriteBulkRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbWriteBulkRequestPacket(this);
        }
