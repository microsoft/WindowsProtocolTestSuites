...
{
    /// <summary>
    /// Packets for SmbWriteMpxSecondary Request
    /// </summary>
    public class SmbWriteMpxSecondaryRequestPacket : SmbSingleRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbWriteMpxSecondaryRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbWriteMpxSecondaryRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbWriteMpxSecondaryRequestPacket(SmbWriteMpxSecondaryRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbWriteMpxSecondaryRequestPacket(this);
        }
