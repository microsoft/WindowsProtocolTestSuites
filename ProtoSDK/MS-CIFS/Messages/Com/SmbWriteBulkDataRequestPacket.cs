...
{
    /// <summary>
    /// Packets for SmbWriteBulkData Request
    /// </summary>
    public class SmbWriteBulkDataRequestPacket : SmbSingleRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbWriteBulkDataRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbWriteBulkDataRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbWriteBulkDataRequestPacket(SmbWriteBulkDataRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbWriteBulkDataRequestPacket(this);
        }
