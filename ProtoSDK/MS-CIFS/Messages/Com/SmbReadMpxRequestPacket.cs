...
{
    /// <summary>
    /// Packets for SmbReadMpx Request
    /// </summary>
    public class SmbReadMpxRequestPacket : SmbSingleRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbReadMpxRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbReadMpxRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbReadMpxRequestPacket(SmbReadMpxRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbReadMpxRequestPacket(this);
        }


        /// <summary>
        /// Encode the struct of SMB_COM_READ_MPX_Request_SMB_Parameters into the struct of SmbParameters
        /// </summary>
        ...
        /// <summary>
        /// Encode the struct of SMB_COM_READ_MPX_Request_SMB_Data into the struct of SmbData
        /// </summary>
