...
{
    /// <summary>
    /// Packets for SmbTransaction2Secondary Request
    /// </summary>
    public class SmbTransaction2SecondaryRequestPacket : SmbSingleRequestPacket
    {
        #region Fields

        private SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters smbParameters;
        private SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters
        /// </summary>
        public SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Data
        /// </summary>
        public SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        /// Constructor.
        /// </summary>
        public SmbTransaction2SecondaryRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransaction2SecondaryRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransaction2SecondaryRequestPacket(SmbTransaction2SecondaryRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbTransaction2SecondaryRequestPacket(this);
        }


        /// <summary>
        /// Encode the struct of SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters
        ...
        protected override void EncodeParameters()
        {
            this.smbParametersBlock = TypeMarshal.ToStruct<SmbParameters>(
                CifsMessageUtils.ToBytes<SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters>(this.smbParameters));
        }


        /// <summary>
        /// Encode the struct of SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Data into the struct of SmbData
        /// </summary>
        ...
        {
            this.smbParameters = TypeMarshal.ToStruct<SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Parameters>(
        ...
        {
            this.smbData = new SMB_COM_TRANSACTION2_SECONDARY_Request_SMB_Data();
            using (MemoryStream memoryStream = new MemoryStream(CifsMessageUtils.ToBytes<SmbData>(this.smbDataBlock)))
            {
                using (Channel channel = new Channel(null, memoryStream))
                {
                    ...
                    this.smbData.Trans2_Parameters = channel.ReadBytes((int)this.smbParameters.ParameterCount);
                    this.smbData.Pad2 = channel.ReadBytes((int)(this.smbParameters.DataOffset - this.smbParameters.ParameterOffset
                        - this.smbParameters.ParameterCount));
                    this.smbData.Trans2_Data = channel.ReadBytes((int)this.smbParameters.DataCount);
                }
            }
        }
