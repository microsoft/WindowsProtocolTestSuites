...
{
    /// <summary>
    /// Packets for SmbNtRename Request
    /// </summary>
    public class SmbNtRenameRequestPacket : SmbSingleRequestPacket
    {
        #region Fields

        private SMB_COM_NT_RENAME_Request_SMB_Parameters smbParameters;
        private SMB_COM_NT_RENAME_Request_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_NT_RENAME_Request_SMB_Parameters
        /// </summary>
        public SMB_COM_NT_RENAME_Request_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_NT_RENAME_Request_SMB_Data
        /// </summary>
        public SMB_COM_NT_RENAME_Request_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        /// Constructor.
        /// </summary>
        public SmbNtRenameRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbNtRenameRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbNtRenameRequestPacket(this);
        }
        ...
        protected override void EncodeParameters()
        {
            this.smbParametersBlock = TypeMarshal.ToStruct<SmbParameters>(
                CifsMessageUtils.ToBytes<SMB_COM_NT_RENAME_Request_SMB_Parameters>(this.smbParameters));
        }
