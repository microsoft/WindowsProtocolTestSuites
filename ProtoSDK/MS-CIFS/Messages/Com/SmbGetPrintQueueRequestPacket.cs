...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbGetPrintQueueRequestPacket : SmbSingleRequestPacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbGetPrintQueueRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbGetPrintQueueRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbGetPrintQueueRequestPacket(SmbGetPrintQueueRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbGetPrintQueueRequestPacket(this);
        }
