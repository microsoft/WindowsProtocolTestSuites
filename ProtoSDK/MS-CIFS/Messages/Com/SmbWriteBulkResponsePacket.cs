...
{
    /// <summary>
    /// Packets for SmbWriteBulk Response
    /// </summary>
    public class SmbWriteBulkResponsePacket : SmbSingleResponsePacket 
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbWriteBulkResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbWriteBulkResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbWriteBulkResponsePacket(SmbWriteBulkResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbWriteBulkResponsePacket(this);
        }
