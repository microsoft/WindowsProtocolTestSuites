...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbSecurityPackageAndxRequestPacket : SmbBatchedRequestPacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbSecurityPackageAndxRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbSecurityPackageAndxRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbSecurityPackageAndxRequestPacket(SmbSecurityPackageAndxRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbSecurityPackageAndxRequestPacket(this);
        }
