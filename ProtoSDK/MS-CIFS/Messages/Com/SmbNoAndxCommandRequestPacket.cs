...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbNoAndxCommandRequestPacket : SmbSingleRequestPacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbNoAndxCommandRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbNoAndxCommandRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbNoAndxCommandRequestPacket(SmbNoAndxCommandRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbNoAndxCommandRequestPacket(this);
        }
