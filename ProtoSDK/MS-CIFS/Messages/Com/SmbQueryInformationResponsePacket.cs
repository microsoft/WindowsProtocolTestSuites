...
{
    /// <summary>
    /// Packets for SmbQueryInformation Response
    /// </summary>
    public class SmbQueryInformationResponsePacket : SmbSingleResponsePacket 
    {
        #region Fields

        private SMB_COM_QUERY_INFORMATION_Response_SMB_Parameters smbParameters;
        private SMB_COM_QUERY_INFORMATION_Response_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_QUERY_INFORMATION_Response_SMB_Parameters
        /// </summary>
        public SMB_COM_QUERY_INFORMATION_Response_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_QUERY_INFORMATION_Response_SMB_Data
        /// </summary>
        public SMB_COM_QUERY_INFORMATION_Response_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        /// Constructor.
        /// </summary>
        public SmbQueryInformationResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbQueryInformationResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbQueryInformationResponsePacket(SmbQueryInformationResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbQueryInformationResponsePacket(this);
        }
        ...
        protected override void DecodeParameters()
        {
            ...
            {
                this.smbParameters = TypeMarshal.ToStruct<SMB_COM_QUERY_INFORMATION_Response_SMB_Parameters>(
        ...
        {
            this.smbData = TypeMarshal.ToStruct<SMB_COM_QUERY_INFORMATION_Response_SMB_Data>(
