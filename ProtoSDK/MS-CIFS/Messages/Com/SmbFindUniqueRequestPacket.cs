...
{
    /// <summary>
    /// Packets for SmbFindUnique Request
    /// </summary>
    public class SmbFindUniqueRequestPacket : SmbSingleRequestPacket
    {
        #region Fields

        private SMB_COM_FIND_UNIQUE_Request_SMB_Parameters smbParameters;
        private SMB_COM_FIND_UNIQUE_Request_SMB_Data smbData;
        ...
        /// <summary>
        /// get or set the Smb_Parameters:SMB_COM_FIND_UNIQUE_Request_SMB_Parameters
        /// </summary>
        public SMB_COM_FIND_UNIQUE_Request_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_FIND_UNIQUE_Request_SMB_Data
        /// </summary>
        public SMB_COM_FIND_UNIQUE_Request_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        /// Constructor.
        /// </summary>
        public SmbFindUniqueRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbFindUniqueRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbFindUniqueRequestPacket(SmbFindUniqueRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
            ...
            this.smbData.ResumeKey = new SMB_Resume_Key[packet.smbData.ResumeKeyLength];

            if (packet.smbData.ResumeKey != null)
            {
                Array.Copy(packet.smbData.ResumeKey, this.smbData.ResumeKey, packet.smbData.ResumeKeyLength);
            }
            else
            {
        ...
        {
            return new SmbFindUniqueRequestPacket(this);
        }


        /// <summary>
        /// Encode the struct of SMB_COM_FIND_UNIQUE_Request_SMB_Parameters into the struct of SmbParameters
        /// </summary>
        protected override void EncodeParameters()
        {
            this.smbParametersBlock = TypeMarshal.ToStruct<SmbParameters>(
                CifsMessageUtils.ToBytes<SMB_COM_FIND_UNIQUE_Request_SMB_Parameters>(this.smbParameters));
        }


        /// <summary>
        /// Encode the struct of SMB_COM_FIND_UNIQUE_Request_SMB_Data into the struct of SmbData
        /// </summary>
        ...
        {
            this.smbParameters = TypeMarshal.ToStruct<SMB_COM_FIND_UNIQUE_Request_SMB_Parameters>(
