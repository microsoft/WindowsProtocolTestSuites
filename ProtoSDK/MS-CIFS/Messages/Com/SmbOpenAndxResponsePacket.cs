...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbOpenAndxResponsePacket : SmbBatchedResponsePacket
    {
        #region Fields

        private SMB_COM_OPEN_ANDX_Response_SMB_Parameters smbParameters;
        private SMB_COM_OPEN_ANDX_Response_SMB_Data smbData;
        ...
        /// </summary>
        public SMB_COM_OPEN_ANDX_Response_SMB_Parameters SmbParameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Smb_Data:SMB_COM_OPEN_ANDX_Response_SMB_Data
        /// </summary>
        public SMB_COM_OPEN_ANDX_Response_SMB_Data SmbData
        {
            get
            {
                return this.smbData;
        ...
        protected override void EncodeData()
        {
            this.smbDataBlock = TypeMarshal.ToStruct<SmbData>(
                CifsMessageUtils.ToBytes<SMB_COM_OPEN_ANDX_Response_SMB_Data>(this.SmbData));
        }
        ...
        protected override void DecodeParameters()
        {
            ...
            {
                this.smbParameters = TypeMarshal.ToStruct<SMB_COM_OPEN_ANDX_Response_SMB_Parameters>(
