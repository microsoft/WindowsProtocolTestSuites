...
{
    /// <summary>
    /// Packets for SmbTransWaitNmpipe SuccessResponse
    /// </summary>
    public class SmbTransWaitNmpipeSuccessResponsePacket : SmbTransactionSuccessResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTransWaitNmpipeSuccessResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransWaitNmpipeSuccessResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransWaitNmpipeSuccessResponsePacket(SmbTransWaitNmpipeSuccessResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTransWaitNmpipeSuccessResponsePacket(this);
        }
