...
{
    /// <summary>
    /// Packets for SmbTransRawWriteNmpipe Request
    /// </summary>
    public class SmbTransRawWriteNmpipeRequestPacket : SmbTransactionRequestPacket
    {
        #region Fields

        private TRANS_RAW_WRITE_NMPIPE_Request_Trans_Data transData;
        ...
        /// <summary>
        /// get or set the Trans_Data:TRANS_RAW_WRITE_NMPIPE_Request_Trans_Data
        /// </summary>
        public TRANS_RAW_WRITE_NMPIPE_Request_Trans_Data TransData
        {
            get
            {
        ...
        /// Constructor.
        /// </summary>
        public SmbTransRawWriteNmpipeRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransRawWriteNmpipeRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransRawWriteNmpipeRequestPacket(SmbTransRawWriteNmpipeRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbTransRawWriteNmpipeRequestPacket(this);
        }
        ...
        {
            this.transData = new TRANS_RAW_WRITE_NMPIPE_Request_Trans_Data();
        }
