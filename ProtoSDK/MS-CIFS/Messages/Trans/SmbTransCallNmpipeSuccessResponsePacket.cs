...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbTransCallNmpipeSuccessResponsePacket : SmbTransactionSuccessResponsePacket
    {
        ...
        private TRANS_CALL_NMPIPE_Response_Trans_Data transData;
        ...
        /// <summary>
        /// get or set the Trans_Data:TRANS_CALL_NMPIPE_Response_Trans_Data
        /// </summary>
        public TRANS_CALL_NMPIPE_Response_Trans_Data TransData
        {
            get
            {
        ...
        /// Constructor.
        /// </summary>
        public SmbTransCallNmpipeSuccessResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransCallNmpipeSuccessResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTransCallNmpipeSuccessResponsePacket(this);
        }
