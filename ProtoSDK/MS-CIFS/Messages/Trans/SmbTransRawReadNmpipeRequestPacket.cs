...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbTransRawReadNmpipeRequestPacket : SmbTransactionRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTransRawReadNmpipeRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransRawReadNmpipeRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransRawReadNmpipeRequestPacket(SmbTransRawReadNmpipeRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTransRawReadNmpipeRequestPacket(this);
        }
