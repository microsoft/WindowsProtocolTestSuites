...
{
    /// <summary>
    /// Packets for SmbTransReadNmpipe SuccessResponse
    /// </summary>
    public class SmbTransReadNmpipeSuccessResponsePacket : SmbTransactionSuccessResponsePacket
    {
        #region Fields

        private TRANS_READ_NMPIPE_Response_Trans_Data transData;
        ...
        /// <summary>
        /// get or set the Trans_Data:TRANS_READ_NMPIPE_Response_Trans_Data
        /// </summary>
        public TRANS_READ_NMPIPE_Response_Trans_Data TransData
        {
            get
            {
        ...
        /// Constructor.
        /// </summary>
        public SmbTransReadNmpipeSuccessResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransReadNmpipeSuccessResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTransReadNmpipeSuccessResponsePacket(this);
        }
