...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbTransMailslotWriteSuccessResponsePacket : SmbTransactionSuccessResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTransMailslotWriteSuccessResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransMailslotWriteSuccessResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransMailslotWriteSuccessResponsePacket(SmbTransMailslotWriteSuccessResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTransMailslotWriteSuccessResponsePacket(this);
        }
