...
{
    /// <summary>
    /// Packets for SmbTransSetNmpipeState SuccessResponse
    /// </summary>
    public class SmbTransSetNmpipeStateSuccessResponsePacket : SmbTransactionSuccessResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTransSetNmpipeStateSuccessResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTransSetNmpipeStateSuccessResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransSetNmpipeStateSuccessResponsePacket(SmbTransSetNmpipeStateSuccessResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTransSetNmpipeStateSuccessResponsePacket(this);
        }
