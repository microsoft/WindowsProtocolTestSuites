...
{
    /// <summary>
    /// Packets for SmbTrans2QueryFileInformationFinal Response
    /// </summary>
    public class SmbTrans2QueryFileInformationFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// <summary>
        /// get or set the Trans2_Parameters:TRANS2_SET_FILE_INFORMATION_Request_Trans2_Parameters
        /// </summary>
        ...
        /// <summary>
        /// get or set the Trans2_Data:TRANS2_SET_FILE_INFORMATION_Request_Trans2_Data
        /// </summary>
        ...
        /// </summary>
        public SmbTrans2QueryFileInformationFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTrans2QueryFileInformationFinalResponsePacket(this);
        }
        ...
        protected override void EncodeTrans2Parameters()
        {
            this.smbData.Trans2_Parameters = CifsMessageUtils.ToBytes<
                  TRANS2_QUERY_PATH_INFORMATION_Response_Trans2_Parameters>(this.trans2Parameters);
        }
