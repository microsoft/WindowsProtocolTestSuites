...
{
    /// <summary>
    /// Packets for SmbTrans2Ioctl2Final Response
    /// </summary>
    public class SmbTrans2Ioctl2FinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2Ioctl2FinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2Ioctl2FinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTrans2Ioctl2FinalResponsePacket(this);
        }
