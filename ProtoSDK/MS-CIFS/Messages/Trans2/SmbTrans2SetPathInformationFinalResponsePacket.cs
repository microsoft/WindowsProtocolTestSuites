...
{
    /// <summary>
    /// Packets for SmbTrans2SetPathInformationFinal Response
    /// </summary>
    public class SmbTrans2SetPathInformationFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2SetPathInformationFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2SetPathInformationFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTrans2SetPathInformationFinalResponsePacket(this);
        }
