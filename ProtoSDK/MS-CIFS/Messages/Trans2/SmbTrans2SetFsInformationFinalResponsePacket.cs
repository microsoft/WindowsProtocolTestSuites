...
{
    /// <summary>
    /// Packets for SmbTrans2SetFsInformationFinal Response
    /// </summary>
    public class SmbTrans2SetFsInformationFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2SetFsInformationFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2SetFsInformationFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTrans2SetFsInformationFinalResponsePacket(this);
        }
