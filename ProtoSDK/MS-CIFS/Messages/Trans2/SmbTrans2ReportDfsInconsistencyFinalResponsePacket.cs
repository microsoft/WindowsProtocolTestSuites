...
{
    /// <summary>
    /// Packets for SmbTrans2ReportDfsInconsistencyFinal Response
    /// </summary>
    public class SmbTrans2ReportDfsInconsistencyFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2ReportDfsInconsistencyFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2ReportDfsInconsistencyFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2ReportDfsInconsistencyFinalResponsePacket(
                SmbTrans2ReportDfsInconsistencyFinalResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2ReportDfsInconsistencyFinalResponsePacket(this);
        }
