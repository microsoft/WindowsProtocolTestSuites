...
{
    /// <summary>
    ///  Packets for SmbTrans2Fsctl Request
    /// </summary>
    public class SmbTrans2FsctlRequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FsctlRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FsctlRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2FsctlRequestPacket(SmbTrans2FsctlRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2FsctlRequestPacket(this);
        }
