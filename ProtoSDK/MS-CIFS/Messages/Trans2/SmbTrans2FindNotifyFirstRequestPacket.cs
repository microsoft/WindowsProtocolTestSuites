...
{
    /// <summary>
    /// Packets for SmbTrans2FindNotifyFirst Request
    /// </summary>
    public class SmbTrans2FindNotifyFirstRequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FindNotifyFirstRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FindNotifyFirstRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2FindNotifyFirstRequestPacket(SmbTrans2FindNotifyFirstRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2FindNotifyFirstRequestPacket(this);
        }
