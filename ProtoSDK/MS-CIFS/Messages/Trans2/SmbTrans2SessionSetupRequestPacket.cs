...
{
    /// <summary>
    /// Packets for SmbTrans2SessionSetup Request
    /// </summary>
    public class SmbTrans2SessionSetupRequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2SessionSetupRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2SessionSetupRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2SessionSetupRequestPacket(SmbTrans2SessionSetupRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2SessionSetupRequestPacket(this);
        }
