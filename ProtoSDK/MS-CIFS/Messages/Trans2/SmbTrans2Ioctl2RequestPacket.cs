...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbTrans2Ioctl2RequestPacket : SmbTransaction2RequestPacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2Ioctl2RequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2Ioctl2RequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2Ioctl2RequestPacket(SmbTrans2Ioctl2RequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2Ioctl2RequestPacket(this);
        }
