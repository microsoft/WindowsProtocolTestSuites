...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbTrans2QueryFsInformationRequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields

        private TRANS2_QUERY_FS_INFORMATION_Request_Trans2_Parameters trans2Parameters;
        ...
        /// <summary>
        /// get or set the Trans2_Parameters:TRANS2_QUERY_FS_INFORMATION_Request_Trans2_Parameters
        /// </summary>
        public TRANS2_QUERY_FS_INFORMATION_Request_Trans2_Parameters Trans2Parameters
        {
            get
            {
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2QueryFsInformationRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2QueryFsInformationRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2QueryFsInformationRequestPacket(SmbTrans2QueryFsInformationRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        ...
        {
            return new SmbTrans2QueryFsInformationRequestPacket(this);
        }
        ...
        protected override void DecodeTrans2Parameters()
        {
            ...
            {
                this.trans2Parameters = TypeMarshal.ToStruct<TRANS2_QUERY_FS_INFORMATION_Request_Trans2_Parameters>(
                    this.smbData.Trans2_Parameters);
            }
        }
