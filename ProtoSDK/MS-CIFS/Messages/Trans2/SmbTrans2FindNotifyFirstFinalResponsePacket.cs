...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    public class SmbTrans2FindNotifyFirstFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FindNotifyFirstFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FindNotifyFirstFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2FindNotifyFirstFinalResponsePacket(SmbTrans2FindNotifyFirstFinalResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2FindNotifyFirstFinalResponsePacket(this);
        }
