...
{
    /// <summary>
    /// Packets for SmbTrans2FindFirst2Final Response
    /// </summary>
    public class SmbTrans2FindFirst2FinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields

        private TRANS2_FIND_FIRST2_Response_Trans2_Parameters trans2Parameters;
        private TRANS2_FIND_FIRST2_Response_Trans2_Data trans2Data;
        ...
        /// </summary>
        public TRANS2_FIND_FIRST2_Response_Trans2_Parameters Trans2Parameters
        {
            get
            {
        ...
        /// </summary>
        public TRANS2_FIND_FIRST2_Response_Trans2_Data Trans2Data
        {
            get
            {
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FindFirst2FinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FindFirst2FinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbTrans2FindFirst2FinalResponsePacket(this);
        }
        ...
        {
            this.smbData.Trans2_Parameters = CifsMessageUtils.ToBytes<TRANS2_FIND_FIRST2_Response_Trans2_Parameters>(
        ...
        protected override void DecodeTrans2Parameters()
        {
            ...
            {
                this.trans2Parameters = TypeMarshal.ToStruct<TRANS2_FIND_FIRST2_Response_Trans2_Parameters>(
