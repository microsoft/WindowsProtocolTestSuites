...
{
    /// <summary>
    /// Packets for SmbTrans2FindNotifyNext Request
    /// </summary>
    public class SmbTrans2FindNotifyNextRequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FindNotifyNextRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FindNotifyNextRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2FindNotifyNextRequestPacket(SmbTrans2FindNotifyNextRequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2FindNotifyNextRequestPacket(this);
        }
