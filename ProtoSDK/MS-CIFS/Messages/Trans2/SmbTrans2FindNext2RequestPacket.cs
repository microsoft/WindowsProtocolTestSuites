...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Cifs
{
    ...
    /// </summary>
    public class SmbTrans2FindNext2RequestPacket : SmbTransaction2RequestPacket
    {
        #region Fields

        private TRANS2_FIND_NEXT2_Request_Trans2_Parameters trans2Parameters;
        private TRANS2_FIND_NEXT2_Request_Trans2_Data trans2Data;
        /// <summary>
        ...
        /// <summary>
        /// This is a fixed length including length of SID, SearchCount, Flags, InformationLevel,
        /// and ResumeKey.
        /// </summary>
        ...
        /// <summary>
        /// get or set the Trans2_Parameters:TRANS2_FIND_NEXT2_Request_Trans2_Parameters
        /// </summary>
        public TRANS2_FIND_NEXT2_Request_Trans2_Parameters Trans2Parameters
        {
            get
            {
        ...
        /// <summary>
        /// get or set the Trans2_Data:TRANS2_FIND_NEXT2_Request_Trans2_Data
        /// </summary>
        public TRANS2_FIND_NEXT2_Request_Trans2_Data Trans2Data
        {
            get
            {
        ...
        /// </summary>
        public SmbTrans2FindNext2RequestPacket(SmbTrans2FindNext2RequestPacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
            ...
            this.trans2Parameters.ResumeKey = packet.trans2Parameters.ResumeKey;
        ...
        protected override void EncodeTrans2Parameters()
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream(this.smbData.Trans2_Parameters))
            {
                using (Channel channel = new Channel(null, memoryStream))
                {
                    ...
                    channel.Write<ushort>(this.trans2Parameters.SID);
                    ...
                    channel.Write<uint>(this.trans2Parameters.ResumeKey);
        ...
        protected override void DecodeTrans2Parameters()
        {
            using (MemoryStream memoryStream = new MemoryStream(this.smbData.Trans2_Parameters))
            {
                using (Channel channel = new Channel(null, memoryStream))
                {
                    this.trans2Parameters.SID = channel.Read<ushort>();
                    ...
                    this.trans2Parameters.ResumeKey = channel.Read<uint>();
