...
{
    /// <summary>
    /// Packets for SmbTrans2FsctlFinal Response
    /// </summary>
    public class SmbTrans2FsctlFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2FsctlFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2FsctlFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2FsctlFinalResponsePacket(SmbTrans2FsctlFinalResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2FsctlFinalResponsePacket(this);
        }
