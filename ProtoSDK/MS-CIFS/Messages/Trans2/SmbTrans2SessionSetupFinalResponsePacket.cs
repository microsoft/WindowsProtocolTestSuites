...
{
    /// <summary>
    /// Packets for SmbTrans2SessionSetupFinal Response
    /// </summary>
    public class SmbTrans2SessionSetupFinalResponsePacket : SmbTransaction2FinalResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbTrans2SessionSetupFinalResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbTrans2SessionSetupFinalResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTrans2SessionSetupFinalResponsePacket(SmbTrans2SessionSetupFinalResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbTrans2SessionSetupFinalResponsePacket(this);
        }
