...
{
    /// <summary>
    /// Packets for SmbNtTransactSetSecurityDesc Response
    /// </summary>
    public class SmbNtTransactSetSecurityDescResponsePacket : SmbNtTransactSuccessResponsePacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbNtTransactSetSecurityDescResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbNtTransactSetSecurityDescResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbNtTransactSetSecurityDescResponsePacket(SmbNtTransactSetSecurityDescResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();   
        }
        ...
        {
            return new SmbNtTransactSetSecurityDescResponsePacket(this);
        }
