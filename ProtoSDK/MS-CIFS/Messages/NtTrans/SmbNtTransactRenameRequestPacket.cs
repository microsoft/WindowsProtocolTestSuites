...
{
    /// <summary>
    /// Packets for SmbNtTransactRename Request
    /// </summary>
    public class SmbNtTransactRenameRequestPacket : SmbNtTransactRequestPacket
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public SmbNtTransactRenameRequestPacket()
            : base()
        {
        ...
        /// </summary>
        public SmbNtTransactRenameRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            return new SmbNtTransactRenameRequestPacket(this);
        }
