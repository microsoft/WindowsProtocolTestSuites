...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Smb
{
    ...
    /// copy chunk. 
    /// </summary>
    public class SmbNtTransFsctlSrvCopyChunkResponsePacket : Cifs.SmbNtTransactIoctlResponsePacket
    {
        #region Fields
        ...
        /// nt trans data
        /// </summary>
        private NT_TRANSACT_COPY_CHUNK_Response_NT_Trans_Data ntTransData;
        ...
        /// <summary>
        /// get or set the NT_Trans_Data:NT_TRANSACT_COPY_CHUNK_Response_NT_Trans_Data 
        /// </summary>
        public new NT_TRANSACT_COPY_CHUNK_Response_NT_Trans_Data NtTransData
        {
            get
            {
            ...
            set
            {
                ...
                data.Data = CifsMessageUtils.ToBytes<NT_TRANSACT_COPY_CHUNK_Response_NT_Trans_Data>(value);
        ...
        /// </summary>
        public SmbNtTransFsctlSrvCopyChunkResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        {
            this.smbData.Data =
                CifsMessageUtils.ToBytes<NT_TRANSACT_COPY_CHUNK_Response_NT_Trans_Data>(this.NtTransData);
        }
