...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Smb
{
    ...
    public class SmbTrans2FindNext2ResponsePacket : Cifs.SmbTrans2FindNext2FinalResponsePacket
    {
        ...
        public SmbTrans2FindNext2ResponsePacket(Cifs.SmbTrans2FindNext2FinalResponsePacket packet)
            : base(packet)
        {
        }
        ...
        {
            return new SmbTrans2FindNext2ResponsePacket(this);
        }
        ...
        /// Constructor. 
        /// </summary>
        public SmbTrans2FindNext2ResponsePacket()
            : base()
        {
        }
        ...
        /// </summary>
        public SmbTrans2FindNext2ResponsePacket(byte[] data)
            : base(data)
        {
        }
