...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Smb
{
    ...
    /// </summary>
    public class SmbTrans2QueryPathInformationRequestPacket : Cifs.SmbTrans2QueryPathInformationRequestPacket
    {
        #region Fields
        ...
        public SmbTrans2QueryPathInformationRequestPacket(Cifs.SmbTrans2QueryPathInformationRequestPacket packet)
            : base(packet)
        {
