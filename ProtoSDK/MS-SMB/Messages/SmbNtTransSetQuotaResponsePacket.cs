...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.Smb
{
    ...
    public class SmbNtTransSetQuotaResponsePacket : SmbNtTransactSuccessResponsePacket
    {
        ...
        /// Constructor. 
        /// </summary>
        public SmbNtTransSetQuotaResponsePacket()
            : base()
        {
        ...
        /// </summary>
        public SmbNtTransSetQuotaResponsePacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbNtTransSetQuotaResponsePacket(SmbNtTransSetQuotaResponsePacket packet)
            : base(packet)
        {
            this.InitDefaultValue();
        }
        ...
        {
            return new SmbNtTransSetQuotaResponsePacket(this);
        }
