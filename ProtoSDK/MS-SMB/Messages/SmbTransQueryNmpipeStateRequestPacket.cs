...
{
    /// <summary>
    /// Packets for SmbTransQueryNmpipeState Request 
    /// </summary>
    public class SmbTransQueryNmpipeStateRequestPacket : Cifs.SmbTransQueryNmpipeStateRequestPacket
    {
        #region Fields
        ...
        public SmbTransQueryNmpipeStateRequestPacket(Cifs.SmbTransQueryNmpipeStateRequestPacket packet)
            : base(packet)
        {
        ...
        /// Constructor. 
        /// </summary>
        public SmbTransQueryNmpipeStateRequestPacket()
            : base()
        {
        }
        ...
        /// </summary>
        public SmbTransQueryNmpipeStateRequestPacket(byte[] data)
            : base(data)
        {
        }
        ...
        /// </summary>
        public SmbTransQueryNmpipeStateRequestPacket(SmbTransQueryNmpipeStateRequestPacket packet)
            : base(packet)
        {
        }
