...
{
    /// <summary>
    /// the request packet of FSCTL_SET_REPARSE_POINT 
    /// </summary>
    public class FsccFsctlSetReparsePointRequestPacket : FsccStandardBytesPacket
    {
        #region Properties
        ...
        public override uint Command
        {
            get
            {
                return (uint)FsControlCommand.FSCTL_SET_REPARSE_POINT;
            }
        }
        ...
        /// default constructor 
        /// </summary>
        public FsccFsctlSetReparsePointRequestPacket()
            : base()
        {
        }
