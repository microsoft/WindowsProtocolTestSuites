...
{
    /// <summary>
    /// the response packet of FSCTL_CREATE_OR_GET_OBJECT_ID 
    /// </summary>
    public class FsccFsctlCreateOrGetObjectIdResponsePacket : FsccStandardBytesPacket
    {
        #region Properties
        ...
        /// default constructor 
        /// </summary>
        public FsccFsctlCreateOrGetObjectIdResponsePacket()
            : base()
        {
        }
