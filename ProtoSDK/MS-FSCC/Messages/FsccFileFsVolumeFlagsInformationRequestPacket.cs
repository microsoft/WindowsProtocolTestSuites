...
{
    /// <summary>
    /// the request packet of FileFsVolumeFlagsInformation 
    /// </summary>
    public class FsccFileFsVolumeFlagsInformationRequestPacket : FsccEmptyPacket
    {
        #region Properties
        ...
        /// default constructor 
        /// </summary>
        public FsccFileFsVolumeFlagsInformationRequestPacket()
            : base()
        {
