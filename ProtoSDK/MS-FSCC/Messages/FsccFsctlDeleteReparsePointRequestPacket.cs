...
{
    /// <summary>
    /// the request packet of FSCTL_DELETE_REPARSE_POINT 
    /// </summary>
    public class FsccFsctlDeleteReparsePointRequestPacket : FsccStandardBytesPacket
    {
        #region Properties
        ...
        /// default constructor 
        /// </summary>
        public FsccFsctlDeleteReparsePointRequestPacket()
            : base()
        {
        }
