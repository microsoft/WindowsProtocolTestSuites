...
namespace Microsoft.Protocols.TestTools.StackSdk.RemoteDesktop.Rdpei
{
    ...
    {
        UP = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UP,

        UP_CANCELED = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UP | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_CANCELED,

        UPDATE = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UPDATE,

        UPDATE_CANCELED = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UPDATE | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_CANCELED,

        DOWN_INRANGE_INCONTACT = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_DOWN | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INRANGE | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INCONTACT,

        UPDATE_INRANGE_INCONTACT = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UPDATE | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INRANGE | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INCONTACT,

        UP_INRANGE = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UP | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INRANGE,

        UPDATE_INRANGE = RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_UPDATE | RDPINPUT_TOUCH_CONTACT_ContactFlags.CONTACT_FLAG_INRANGE
    }
