...
{
    /// <summary>
    /// The alter_context_response PDU is used to indicate 
    /// the server's response to an alter_context request. 
    /// The PDU format is identical to bind_ack, except that 
    /// the value of the PTYPE field is set to alter_context_response. 
    /// The max_xmit_frag, max_recv_frag, assoc_group_id 
    /// and sec_addr fields are ignored.
    /// </summary>
    public class RpceCoAlterContextRespPdu : RpceCoPdu
    {
        /// <summary>
