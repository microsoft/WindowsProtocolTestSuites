...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile
{
    ...
    public class KerberosServerSecurityContext : ServerSecurityContext, IDisposable
    {
        ...
        /// <summary>
        /// Constructor.
        /// Use principal's password with RC4_HMAC encryption type to generate encryption key of the ticket.
        /// </summary>
        ...
        public KerberosServerSecurityContext(
            ...
            : this(new EncryptionKey(new KerbInt32((int)EncryptionType.RC4_HMAC),
               new Asn1OctetString(KeyGenerator.MakeKey(EncryptionType.RC4_HMAC, ticketEncryptPassword, null))))
        {
        }
