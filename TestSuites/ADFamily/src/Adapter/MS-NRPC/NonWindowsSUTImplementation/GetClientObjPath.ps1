...
#         ActiveDirectory's DN format,and give parameter $clientNetBiosName's 
#         value to CN=$clientNetBiosName;
...
#         cn=$clientNetBiosName, cn=computers, dc=$domainNetBiosName, dc=$domainNameSuffix
#-----------------------------------------------------------------------------------------
