...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Ldap
{
    ...
    [TestClassAttribute()]
    public partial class TestScenarioQueryRootDSE_AD_DSWin2K8R2 : PtfTestClassBase
    {

        public TestScenarioQueryRootDSE_AD_DSWin2K8R2()
        {
        ...
        [TestCategory("Main")]
        public void LDAP_TestScenarioQueryRootDSE_AD_DSWin2K8R2S0()
        {
            this.Manager.BeginTest("TestScenarioQueryRootDSE_AD_DSWin2K8R2S0");
            ...
            this.Manager.Comment("executing step \'call SearchOpReq(\"null\",\"msDS-TopQuotaUsage;Range=2-2\",baseObject" +
                    ",[\"msDS-TopQuotaUsage\"],NoExtendedControl,AD_DS)\'");
            this.IAD_LDAPModelAdapterInstance.SearchOpReq("null", "msDS-TopQuotaUsage;Range=2-2", ((SearchScope)(0)), new List<string> { "msDS-TopQuotaUsage" }, null, ((ADImplementations)(0)));
            this.Manager.Comment("reaching state \'S15\'");
            this.Manager.Comment("checking step \'return SearchOpReq\'");
            TestScenarioQueryRootDSE_AD_DSWin2K8R2S18();
            this.Manager.EndTest();
        }

        private void TestScenarioQueryRootDSE_AD_DSWin2K8R2S18()
        {
            this.Manager.Comment("reaching state \'S18\'");
            this.Manager.Comment("executing step \'call SearchOpReq(\"null\",\"(&(DnsDomain=adts88))\",baseObject,[\"netl" +
                    "ogon\"],NoExtendedControl,AD_DS)\'");
            this.IAD_LDAPModelAdapterInstance.SearchOpReq("null", "(&(DnsDomain=adts88))", ((SearchScope)(0)), new List<string> { "netlogon" }, null, ((ADImplementations)(0)));
            this.Manager.Comment("reaching state \'S19\'");
            this.Manager.Comment("checking step \'return SearchOpReq\'");
            this.Manager.Comment("reaching state \'S20\'");
            int temp0 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestScenarioQueryRootDSE_AD_DSWin2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioQueryRootDSE_AD_DSWin2K8R2S0SearchOpResponseChecker)), new ExpectedEvent(TestScenarioQueryRootDSE_AD_DSWin2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioQueryRootDSE_AD_DSWin2K8R2S0SearchOpResponseChecker1)));
            if ((temp0 == 0))
            {
            ...
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(TestScenarioQueryRootDSE_AD_DSWin2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioQueryRootDSE_AD_DSWin2K8R2S0SearchOpResponseChecker)), new ExpectedEvent(TestScenarioQueryRootDSE_AD_DSWin2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioQueryRootDSE_AD_DSWin2K8R2S0SearchOpResponseChecker1)));
        label0:
            ;
        }

        private void TestScenarioQueryRootDSE_AD_DSWin2K8R2S0SearchOpResponseChecker(SearchResp response)
        {
        ...
        [TestCategory("ForestWin2008R2")]
        [TestCategory("Main")]
        public void LDAP_TestScenarioQueryRootDSE_AD_DSWin2K8R2S2()
        {
            this.Manager.BeginTest("TestScenarioQueryRootDSE_AD_DSWin2K8R2S2");
            ...
            this.Manager.Comment("executing step \'call SearchOpReq(\"null\",\"msDS-TopQuotaUsage;Range=0-*\",baseObject" +
                    ",[\"msDS-TopQuotaUsage\"],NoExtendedControl,AD_DS)\'");
            this.IAD_LDAPModelAdapterInstance.SearchOpReq("null", "msDS-TopQuotaUsage;Range=0-*", ((SearchScope)(0)), new List<string> { "msDS-TopQuotaUsage" }, null, ((ADImplementations)(0)));
        ...
        [TestCategory("ForestWin2008R2")]
        [TestCategory("Main")]
        public void LDAP_TestScenarioQueryRootDSE_AD_DSWin2K8R2S4()
        {
            this.Manager.BeginTest("TestScenarioQueryRootDSE_AD_DSWin2K8R2S4");
            ...
            this.Manager.Comment("executing step \'call SearchOpReq(\"null\",\"msDS-TopQuotaUsage;Range=1-9\",baseObject" +
                    ",[\"msDS-TopQuotaUsage\"],NoExtendedControl,AD_DS)\'");
            this.IAD_LDAPModelAdapterInstance.SearchOpReq("null", "msDS-TopQuotaUsage;Range=1-9", ((SearchScope)(0)), new List<string> { "msDS-TopQuotaUsage" }, null, ((ADImplementations)(0)));
