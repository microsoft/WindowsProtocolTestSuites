...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Ldap
{
    ...
    [TestClassAttribute()]
    public partial class TestScenarioExtendedControlsSearch4Win2K8R2 : PtfTestClassBase
    {

        public TestScenarioExtendedControlsSearch4Win2K8R2()
        {
        ...
        [TestCategory("Main")]
        public void LDAP_TestScenarioExtendedControlsSearch4Win2K8R2S0()
        {
            this.Manager.BeginTest("TestScenarioExtendedControlsSearch4Win2K8R2S0");
            ...
            int temp0 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestScenarioExtendedControlsSearch4Win2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker)), new ExpectedEvent(TestScenarioExtendedControlsSearch4Win2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker1)));
            if ((temp0 == 0))
            {
            ...
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(TestScenarioExtendedControlsSearch4Win2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker)), new ExpectedEvent(TestScenarioExtendedControlsSearch4Win2K8R2.SearchOpResponseInfo, null, new SearchOpResponseDelegate1(this.TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker1)));
        label0:
            ;
            this.Manager.EndTest();
        }

        private void TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker(SearchResp response)
        {
        ...
        private void TestScenarioExtendedControlsSearch4Win2K8R2S0SearchOpResponseChecker1(SearchResp response)
        {
