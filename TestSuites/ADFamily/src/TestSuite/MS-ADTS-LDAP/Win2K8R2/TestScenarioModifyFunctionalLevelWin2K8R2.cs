...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Ldap
{
    ...
    public partial class TestScenarioModifyFunctionalLevelWin2K8R2 : PtfTestClassBase
    {
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S0()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 4", new List<string> { "distinguishedName: CN=RODC,DC=writableDC" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp0);
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S10()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 4", new List<string> { "distinguishedName: CN=RODC,DC=WritableDCNotSameDomain" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp1);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S12()
        {
            ...
            this.Manager.Comment("executing step \'call ModifyOperation({\"msDS-Behavior-Version: 4\"->[\"distinguished" +
                    ...
                    ")\'");
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 4", new List<string> { "distinguishedName: CN=Partitions,CN=Configuration,DC=NotPDCFSMO" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp2);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S14()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 5", new List<string> { "distinguishedName: DC=adts88" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp3);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S16()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 0", new List<string> { "instanceType: 4", "objectCategory: CN=Cross-Ref-Container,CN=Schema,CN=Configuration,DC=adts88", "objectClass: top;crossRefContainer", "distinguishedName: CN=Partitions,CN=Configuration,DC=adts88", "msDS-Behavior-Version: 2" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp4);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
            this.Manager.Checkpoint("MS-AD_LDAP_R4339");
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S4()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 2", new List<string> { "instanceType: 4", "objectCategory: CN=NTDS-DSA,CN=Schema,CN=Configuration,DC=adts88", "objectClass: top;applicationSettings;nTDSDSA", "distinguishedName: CN=NTDS Settings,CN=WIN-6IEHBFZ8AMV,CN=Servers,CN=Default-First-Site-Name,CN=Sites,CN=Configuration,DC=adts88", "msDS-Behavior-Version: 3" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp6);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
            this.Manager.Checkpoint("MS-AD_LDAP_R4339");
            this.Manager.Checkpoint("MS-AD_LDAP_R710");
        ...
        public void LDAP_TestScenarioModifyFunctionalLevelWin2K8R2S6()
        {
            ...
            this.IAD_LDAPModelAdapterInstance.ModifyOperation(new Dictionary<string, List<string>> { { "msDS-Behavior-Version: 4", new List<string> { "distinguishedName: CN=Users,DC=adts88" } } }, ((RightsOnAttributes)(0)), null, ((ADImplementations)(0)), ServerVersion.Win2008R2, false, out temp7);
            this.Manager.Checkpoint("MS-AD_LDAP_R4343");
