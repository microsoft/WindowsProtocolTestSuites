...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Nrpc
{
    ...
    [TestClassAttribute()]
    public partial class BVT_Test_MaintainSecureChannel_NetrLogonGetCapabilities : PtfTestClassBase
    {

        public BVT_Test_MaintainSecureChannel_NetrLogonGetCapabilities()
        {
        ...
        public void NRPC_BVT_Test_MaintainSecureChannel_NetrLogonGetCapabilitiesS0()
        {
            this.Manager.BeginTest("BVT_Test_MaintainSecureChannel_NetrLogonGetCapabilitiesS0");
            ...
            temp3 = this.INrpcServerAdapterInstance.NetrLogonGetCapabilities(Microsoft.Protocols.TestSuites.ActiveDirectory.Nrpc.ComputerType.PrimaryDc, Microsoft.Protocols.TestSuites.ActiveDirectory.Nrpc.ComputerType.Client, true, 1u);
            ...
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Nrpc.HRESULT>(this.Manager, ((Microsoft.Protocols.TestSuites.ActiveDirectory.Nrpc.HRESULT)(0)), temp3, "return of NetrLogonGetCapabilities, state S7");
