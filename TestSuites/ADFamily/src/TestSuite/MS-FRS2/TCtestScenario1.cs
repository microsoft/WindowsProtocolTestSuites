...
namespace GeneratedTests
{
    ...
    public partial class TCtestScenario1 : PtfTestClassBase
    {
        ...
        static System.Reflection.MethodBase InitializationInfo = TestManagerHelpers.GetMethodInfo(typeof(Microsoft.Protocols.TestSuites.MS_FRS2.IFRS2ManagedAdapter), "Initialization", typeof(FRS2Model.OSVersion), typeof(Dictionary<System.Int32, FRS2Model.connectionProperty>), typeof(Dictionary<System.Int32, FRS2Model.FromServer>), typeof(Dictionary<System.String, System.Int32>), typeof(Dictionary<System.String, FRS2Model.ReplicationGroupTypes>), typeof(Dictionary<System.Int32, System.String>), typeof(Dictionary<System.Int32, FRS2Model.accessLevels>), typeof(Dictionary<System.Int32, FRS2Model.connectionProperty>));
        ...
        public virtual void FRS2_TCtestScenario1S0()
        {
            ...
            temp0 = this.IFRS2ManagedAdapterInstance.Initialization(FRS2Model.OSVersion.Windows7, new Dictionary<System.Int32, FRS2Model.connectionProperty>() { { 1, FRS2Model.connectionProperty.enabled }, { 2, FRS2Model.connectionProperty.enabled }, { 3, FRS2Model.connectionProperty.enabled }, { 4, FRS2Model.connectionProperty.disabled } }, new Dictionary<System.Int32, FRS2Model.FromServer>() { { 1, FRS2Model.FromServer.exists }, { 2, FRS2Model.FromServer.exists }, { 3, FRS2Model.FromServer.exists }, { 4, FRS2Model.FromServer.exists } }, new Dictionary<System.String, System.Int32> { { "A", 1 }, { "B", 2 }, { "C", 3 }, { "D", 4 } }, new Dictionary<System.String, FRS2Model.ReplicationGroupTypes>() { { "A", FRS2Model.ReplicationGroupTypes.sysvol }, { "B", FRS2Model.ReplicationGroupTypes.protection }, { "C", FRS2Model.ReplicationGroupTypes.sysvol }, { "D", FRS2Model.ReplicationGroupTypes.sysvol } }, new Dictionary<System.Int32, System.String> { { 1, "A" }, { 2, "B" }, { 3, "C" }, { 4, "D"} }, new Dictionary<System.Int32, FRS2Model.accessLevels> { { 1, FRS2Model.accessLevels.writeOnly }, { 2, FRS2Model.accessLevels.readWrite }, { 3, FRS2Model.accessLevels.readOnly }, { 4, FRS2Model.accessLevels.readWrite } }, new Dictionary<System.Int32, FRS2Model.connectionProperty> { { 1, FRS2Model.connectionProperty.enabled }, { 2, FRS2Model.connectionProperty.disabled }, { 3, FRS2Model.connectionProperty.enabled }, { 4, FRS2Model.connectionProperty.enabled } });
