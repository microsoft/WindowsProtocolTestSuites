...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Samr
{
    public partial class SAMR_TestSuite : TestClassBase
    {
        ...
        [Description("This is to test SamrGetDisplayEnumerationIndex2 with DomainDisplayUser.")]
        public void SamrGetDisplayEnumerationIndex2_User()
        {
        ...
        public void SamrGetDisplayEnumerationIndex2_User_InvalidHandle()
        {
            ConnectAndOpenDomain(_samrProtocolAdapter.pdcFqdn, _samrProtocolAdapter.PrimaryDomainDnsName, out _serverHandle, out _domainHandle);
        ...
        public void SamrGetDisplayEnumerationIndex2_User_STATUS_ACCESS_DENIED()
        {
        ...
        public void SamrGetDisplayEnumerationIndex2_User_InvalidDisplayInformationClass()
        {
            ConnectAndOpenDomain(_samrProtocolAdapter.pdcFqdn, _samrProtocolAdapter.PrimaryDomainDnsName, out _serverHandle, out _domainHandle);
        ...
        public void SamrGetDisplayEnumerationIndex2_User_STATUS_NO_MORE_ENTRIES()
        {
            ConnectAndOpenDomain(_samrProtocolAdapter.pdcFqdn, _samrProtocolAdapter.PrimaryDomainDnsName, out _serverHandle, out _domainHandle);
            ...
            Site.Log.Add(LogEntryKind.TestStep, "Check whether there is such user with prefix {0} existing in the database.", prefix);
            ...
            string filter = string.Format("(&(objectclass=user)(userAccountControl:1.2.840.113556.1.4.803:=512)(sAMAccountName=*{0}*))", prefix);
