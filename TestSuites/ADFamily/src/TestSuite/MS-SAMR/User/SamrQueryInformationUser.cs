...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Samr
{
    public partial class SAMR_TestSuite : TestClassBase
    {
        ...
        [Description("This is to test SamrQueryInformationUser with UserAllInformation.")]
        public void SamrQueryInformationUser_UserAllInformation()
        {
            ...
            _samrProtocolAdapter.VerifyUserAllInformationFields(_samrProtocolAdapter.DomainAdministratorName, userInfo, Utilities.USER_READ_GENERAL | Utilities.USER_READ_LOGON | Utilities.USER_READ_ACCOUNT | Utilities.USER_READ_PREFERENCES);
        }
