...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Samr
{
    public partial class SAMR_TestSuite : TestClassBase
    {
        ...
        [Description("Calls SamrConnect2 with domain admin account and SAM_SERVER_READ access. Expects a successful return.")]
        [TestMethod]
        public void SamrConnect2_SUCCESS()
        {
            ...
            Site.Log.Add(LogEntryKind.TestStep,
                string.Format("SamrConnect2, Server:{0}, DesiredAccess: SAM_SERVER_READ.",
                _samrProtocolAdapter.pdcNetBIOSName));
