...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Security
{
    ...
    public partial class TCTDOOperation_Scenario5_2K8R2 : PtfTestClassBase
    {

        public TCTDOOperation_Scenario5_2K8R2()
        {
        ...
        protected override void TestInitialize()
        {
            ...
            this.IMS_ADTS_TDOAdapterInstance = ((Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Security.IMS_ADTS_TDOAdapter)(this.GetAdapter(typeof(Microsoft.Protocols.TestSuites.ActiveDirectory.Adts.Security.IMS_ADTS_TDOAdapter))));
        }
        ...
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S0()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S0");
        ...
        [TestCategory("DomainWin2008R2")]
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S10()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S10");
            ...
            temp3 = this.IMS_ADTS_TDOAdapterInstance.TrustedForestInformation("TrustObject1", this.Make<ProtocolMessageStructures.Trusted_Forest_Information>(new string[] {
                            ...
                            ProtocolMessageStructures.RecordType.ForestTrustDomainInfo}));
            ...
            this.Manager.Comment("executing step \'call TrustedForestInformation(\"TrustObject2\",Trusted_Forest_Infor" +
                    "mation(NetBiosName=\"System1\",ValueSID=\"SID2\",sdcBit=Set,ndcBit=NotSet,recType=Fo" +
                    "restTrustDomainInfo))\'");
            temp5 = this.IMS_ADTS_TDOAdapterInstance.TrustedForestInformation("TrustObject2", this.Make<ProtocolMessageStructures.Trusted_Forest_Information>(new string[] {
                            ...
                            "SID2",
                            ProtocolMessageStructures.SDCFlag.Set,
                            ProtocolMessageStructures.NDCFlag.NotSet,
                            ProtocolMessageStructures.RecordType.ForestTrustDomainInfo}));
            ...
            TCTDOOperation_Scenario5_2K8R2S54();
            this.Manager.EndTest();
        }

        private void TCTDOOperation_Scenario5_2K8R2S54()
        {
            this.Manager.Comment("reaching state \'S54\'");
            this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(TCTDOOperation_Scenario5_2K8R2.DeleteTDOInfo, null, new DeleteTDODelegate1(this.TCTDOOperation_Scenario5_2K8R2S10DeleteTDOChecker)));
            this.Manager.Comment("reaching state \'S59\'");
        }

        private void TCTDOOperation_Scenario5_2K8R2S10DeleteTDOChecker()
        {
            this.Manager.Comment("checking step \'return DeleteTDO\'");
        }
        #endregion
        ...
        [TestCategory("DomainWin2008R2")]
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S2()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S2");
        ...
        [TestCategory("DomainWin2008R2")]
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S4()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S4");
            ...
            bool temp12;
            this.Manager.Comment("executing step \'call TrustedForestInformation(\"TrustObject2\",Trusted_Forest_Infor" +
                    "mation(NetBiosName=\"System1\",ValueSID=\"SID2\",sdcBit=Set,ndcBit=Set,recType=Fores" +
                    "tTrustDomainInfo))\'");
        ...
        [TestCategory("DomainWin2008R2")]
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S6()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S6");
        ...
        [TestCategory("DomainWin2008R2")]
        [TestMethod]
        public void Security_TCTDOOperation_Scenario5_2K8R2S8()
        {
            this.Manager.BeginTest("TCTDOOperation_Scenario5_2K8R2S8");
