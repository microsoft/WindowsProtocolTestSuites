...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad {
    ...
    public partial class TestScenarioS9 : PtfTestClassBase {
        ...
        public TestScenarioS9() {
            this.SetSwitch("ProceedControlTimeout", "100");
            this.SetSwitch("QuiescenceTimeout", "10000");
        }
        
        #region Expect Delegates
        public delegate void EnumerateAccountsDelegate1(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse);
        ...
        static System.Reflection.EventInfo EnumerateAccountsInfo = TestManagerHelpers.GetEventInfo(typeof(Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.ILsadManagedAdapter), "EnumerateAccounts");
        ...
        public void LSAD_TestScenarioS9S0() {
            this.Manager.BeginTest("TestScenarioS9S0");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(11,35)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(11, 35);
            this.Manager.Comment("reaching state \'S60\'");
            this.Manager.Comment("checking step \'return EnumerateAccountsRequest\'");
            TestScenarioS9S72();
            this.Manager.EndTest();
        }
        
        private void TestScenarioS9S72() {
            this.Manager.Comment("reaching state \'S72\'");
            int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker1)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker2)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker3)));
            if ((temp4 == 0)) {
                TestScenarioS9S74();
                goto label0;
            }
            ...
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker1)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker2)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S0EnumerateAccountsChecker3)));
        label0:
;
        }
        
        private void TestScenarioS9S0EnumerateAccountsChecker(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(11,EnumerateNone)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 11, handleInput, "handleInput of EnumerateAccounts, state S72");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse.EnumerateNone, actionResponse, "actionResponse of EnumerateAccounts, state S72");
        }
        
        private void TestScenarioS9S74() {
        ...
        private void TestScenarioS9S76() {
            this.Manager.Comment("reaching state \'S76\'");
            this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(TestScenarioS9.CloseInfo, null, new CloseDelegate1(this.TestScenarioS9S0CloseChecker)));
            this.Manager.Comment("reaching state \'S77\'");
        }
        
        private void TestScenarioS9S0CloseChecker(Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.Handle handleAfterClose, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.ErrorStatus @return) {
        ...
        private void TestScenarioS9S0EnumerateAccountsChecker1(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(1,EnumerateSome)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, handleInput, "handleInput of EnumerateAccounts, state S72");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, ((Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse)(1)), actionResponse, "actionResponse of EnumerateAccounts, state S72");
        }
        
        private void TestScenarioS9S0EnumerateAccountsChecker2(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(1,EnumerateNone)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, handleInput, "handleInput of EnumerateAccounts, state S72");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse.EnumerateNone, actionResponse, "actionResponse of EnumerateAccounts, state S72");
        }
        
        private void TestScenarioS9S0EnumerateAccountsChecker3(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(1,EnumerateAll)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, handleInput, "handleInput of EnumerateAccounts, state S72");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, ((Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse)(0)), actionResponse, "actionResponse of EnumerateAccounts, state S72");
        }
        #endregion
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S10() {
            this.Manager.BeginTest("TestScenarioS9S10");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(1,35)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(1, 35);
        ...
        private void TestScenarioS9S73() {
            this.Manager.Comment("reaching state \'S73\'");
            int temp9 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S10EnumerateAccountsChecker)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S10EnumerateAccountsChecker1)));
            if ((temp9 == 0)) {
                TestScenarioS9S75();
                goto label1;
            }
            ...
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S10EnumerateAccountsChecker)), new ExpectedEvent(TestScenarioS9.EnumerateAccountsInfo, null, new EnumerateAccountsDelegate1(this.TestScenarioS9S10EnumerateAccountsChecker1)));
        label1:
;
        }
        
        private void TestScenarioS9S10EnumerateAccountsChecker(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(11,EnumerateNone)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 11, handleInput, "handleInput of EnumerateAccounts, state S73");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse.EnumerateNone, actionResponse, "actionResponse of EnumerateAccounts, state S73");
        }
        
        private void TestScenarioS9S75() {
        ...
        private void TestScenarioS9S10EnumerateAccountsChecker1(int handleInput, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse actionResponse) {
            this.Manager.Comment("checking step \'event EnumerateAccounts(1,EnumerateNone)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, handleInput, "handleInput of EnumerateAccounts, state S73");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse>(this.Manager, Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad.enumerateResponse.EnumerateNone, actionResponse, "actionResponse of EnumerateAccounts, state S73");
        }
        #endregion
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S12() {
            this.Manager.BeginTest("TestScenarioS9S12");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(11,0)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(11, 0);
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S14() {
            this.Manager.BeginTest("TestScenarioS9S14");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(11,5)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(11, 5);
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S16() {
            this.Manager.BeginTest("TestScenarioS9S16");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(1,0)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(1, 0);
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S18() {
            this.Manager.BeginTest("TestScenarioS9S18");
            ...
            this.Manager.Comment("executing step \'call EnumerateAccountsRequest(1,5)\'");
            this.ILsadManagedAdapterInstance.EnumerateAccountsRequest(1, 5);
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S2() {
            this.Manager.BeginTest("TestScenarioS9S2");
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S20() {
            this.Manager.BeginTest("TestScenarioS9S20");
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S22() {
            this.Manager.BeginTest("TestScenarioS9S22");
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S4() {
            this.Manager.BeginTest("TestScenarioS9S4");
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S6() {
            this.Manager.BeginTest("TestScenarioS9S6");
        ...
        [TestCategory("MS-LSAD")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        public void LSAD_TestScenarioS9S8() {
            this.Manager.BeginTest("TestScenarioS9S8");
