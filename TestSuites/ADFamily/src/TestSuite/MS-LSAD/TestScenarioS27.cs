...
namespace Microsoft.Protocols.TestSuites.ActiveDirectory.Lsad {
    ...
    public partial class TestScenarioS27 : PtfTestClassBase {
        ...
        protected override void TestInitialize() {
            ...
            this.ILsadManagedAdapterInstance.EnumeratePrivileges += ILsadManagedAdapterInstance_EnumeratePrivileges;
        }

        private void ILsadManagedAdapterInstance_EnumeratePrivileges(int handleInput, enumerateResponse actionResponse)
        {
            this.Manager.AddEvent(EnumeratePrivilegesInfo, this.ILsadManagedAdapterInstance, new object[] { handleInput, actionResponse });
        }
