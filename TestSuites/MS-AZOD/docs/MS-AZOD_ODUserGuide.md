#MS-AZOD Server Test Suite User Guide
...
| -------------| ------------- |
| Operating system| Microsoft Windows Server 2012 or later version, 64-bit edition, with the latest updates| 
...
>Microsoft Visual Studio 2012, Protocol Test Framework (1.0.2485.0) and Microsoft Message Analyzer 1.3.1 (build 4.0.7551.0) must be installed on the client computer before running the MS-AZOD-TestSuite-ODEP.msi installer.
...
![image25.png](./image/MS-AZOD_ODUserGuide/image25.png)
* Disable the NetworkManager to enable IPV4 Address.
![image26.png](./image/MS-AZOD_ODUserGuide/image26.png)
* Disable the iptables. In order to support IPv6, you must disable the ip6tables.
![image27.png](./image/MS-AZOD_ODUserGuide/image27.png)
...
![image28.png](./image/MS-AZOD_ODUserGuide/image28.png)
...
![image29.png](./image/MS-AZOD_ODUserGuide/image29.png)
...
![image34.png](./image/MS-AZOD_ODUserGuide/image34.png)
An example of /var/kerberos/krb5kdc/kdc.conf is below.
![image35.png](./image/MS-AZOD_ODUserGuide/image35.png)
* Create the KDC database on the MIT KDC realm.
![image36.png](./image/MS-AZOD_ODUserGuide/image36.png)
...
![image37.png](./image/MS-AZOD_ODUserGuide/image37.png)
* Add administrators to the Kerberos database. For example, admin/admin.
![image38.png](./image/MS-AZOD_ODUserGuide/image38.png)
...
![image39.png](./image/MS-AZOD_ODUserGuide/image39.png)
...
![image42.png](./image/MS-AZOD_ODUserGuide/image42.png)
...
![image43.png](./image/MS-AZOD_ODUserGuide/image43.png)
...
![image44.png](./image/MS-AZOD_ODUserGuide/image44.png)
...
![image45.png](./image/MS-AZOD_ODUserGuide/image45.png)
