...
namespace Microsoft.Protocol.TestSuites.Azod.Adapter
{
    ...
    public class ExpectedMessage
    {
        ...
        /// <summary>
        /// Verify whether the source and destination of message is expected
        /// </summary>
        /// <param name="message">A MMA message</param>
        /// <param name="endpointRoles">Endpoint Roles of the test</param>
        /// <returns></returns>
    ...
    public class VerifyItemList
    {
        ...
        /// <summary>
        /// Verify wether a complexValue apply this verifyList
        /// </summary>
        /// <param name="complexValue">A complexValue to verified</param>
        /// <returns></returns>
        public bool Verify(Object value)
        {
            if (Operation.ToLower().Equals("and"))
            {
                // Process AND Verifycation
                return VerifyAnd(value);
            }
            else if (Operation.ToLower().Equals("or"))
            {
