...
$ScriptsSignalFile = "$WorkingPath\Configure-Node01.Completed.signal"
Push-Location $WorkingPath

Function Prepare() {
    .\Write-Info.ps1 "Executing [Configure-Node01.ps1] ..." -ForegroundColor Cyan
    ...
    $LogPath = "$WorkingPath\Configure-Node01.ps1.log"
    try {
...
Function Phase3 {
    ...
    .\SetPasswordNeverExpires.ps1
     ...
     .\Create-ServerFailoverEnv.ps1

    # Create QUIC Environment
    # Only for Azure Editions
...
Function Finish {
    .\Write-Info.ps1 "Write signal file: Configure-Node01.Completed.signal to system drive."
    cmd /C ECHO CONFIG FINISHED>$ScriptsSignalFile

    .\Write-Info.ps1 "Node01 Configuration finished."
    .\Write-Info.ps1 "EXECUTE [Configure-Node01.ps1] FINISHED (NOT VERIFIED)." -ForegroundColor Green
