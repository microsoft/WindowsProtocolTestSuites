...
namespace Microsoft.Protocols.TestSuites.FileSharing.Common.Adapter
{
    ...
    public class Smb2FunctionalClient
    {
        ...
        #region SQOS
        /// <summary>
        /// Send SQOS request and receive response
        /// The difference between the two overloaded functions is that this one uses a constructed SqosRequest as input parameter,
        /// the other one can construct SqosRequest by itself
        /// </summary>
        /// <param name="treeId">Tree id of TreeConnect</param>
        /// <param name="fileId">FILEID of Create</param>
        /// <param name="sqosRequest">The constructed sqos request structure</param>
        /// <param name="sqosResponse">The received sqos response</param>
        /// <param name="checker">Response checker</param>
        /// <returns>Status of the sqos response</returns>
        public uint SendAndReceiveSqosPacket(
            uint treeId,
            FILEID fileId,
            STORAGE_QOS_CONTROL_Request sqosRequest,
            out STORAGE_QOS_CONTROL_Response? sqosResponse,
            ResponseChecker<IOCTL_Response> checker = null)
        {
            ...
            uint status = client.IoCtl(
                ...
                sessionId,
                treeId,
                CtlCode_Values.FSCTL_STORAGE_QOS_CONTROL,
                fileId,
                0,
                TypeMarshal.ToBytes<STORAGE_QOS_CONTROL_Request>(sqosRequest),
            ...
            sqosResponse = null;
            if (outputInResponse != null)
            {
                sqosResponse = TypeMarshal.ToStruct<STORAGE_QOS_CONTROL_Response>(outputInResponse);
            }
        ...
        /// <param name="treeId">Tree id of TreeConnect</param>
        /// <param name="fileId">FILEID of Create</param>
        /// <param name="options">Specifies the option field in SQOS request</param>
        /// <param name="logicalFlowId">Specifies the GUID of the logical flow to which the current operation applies</param>
        /// <param name="policyId">Specifies the GUID of the Quality of Service policy to be applied to the logical flow</param>
        /// <param name="initiatorId">Specifies the GUID of the initiator of the logical flow</param>
        /// <param name="initiatorName">Specifies the name of the logical flow initiator</param>
        /// <param name="initiatorNodeName">Specifies the name of the node hosting the logical flow initiator</param>
        /// <param name="sqosResponse">The received sqos response</param>
        /// <param name="ioCountIncrement">Specifies the total number of I/O requests issued by the initiator on the logical flow</param>
        /// <param name="normalizedIoCountIncrement">Specifies the total number of normalized 8-KB I/O requests issued by the initiator on the logical flow</param>
        /// <param name="latencyIncrement">Specifies the total latency (accumulated across all I/O requests for the logical flow) measured by the initiator,
        /// including any delay accumulated by I/O requests in the initiator¡¯s queues while waiting to be issued to lower layers</param>
        /// <param name="lowerLatencyIncrement">Specifies The total latency (accumulated across all I/O requests for the logical flow) measured by the initiator, 
        /// excluding any delay accumulated by I/O requests in the initiator¡¯s queues while waiting to be issued to lower layers</param>
        /// <param name="checker">Response checker</param>
        /// <returns>Status of the sqos response</returns>
        public uint SendAndReceiveSqosPacket(
            uint treeId,
            ...
            ResponseChecker<IOCTL_Response> checker = null)
        {
            STORAGE_QOS_CONTROL_Request sqosRequest = ConstructSqosRequest(
            ...
            return SendAndReceiveSqosPacket(treeId, fileId, sqosRequest, out sqosResponse, checker);
        }

        /// <summary>
        /// Construct an SQOS request structure
        /// </summary>
        /// <param name="protocolVersion">SQOS protocol version</param>
        /// <param name="options">Specifies the option field in SQOS request</param>
        /// <param name="logicalFlowId">Specifies the GUID of the logical flow to which the current operation applies</param>
        /// <param name="policyId">Specifies the GUID of the Quality of Service policy to be applied to the logical flow</param>
        /// <param name="initiatorId">Specifies the GUID of the initiator of the logical flow</param>
        ...
        /// <param name="lowerLatencyIncrement">Specifies The total latency (accumulated across all I/O requests for the logical flow) measured by the initiator, 
        /// excluding any delay accumulated by I/O requests in the initiator¡¯s queues while waiting to be issued to lower layers</param>
        /// <returns>The constructed SQOS request structure</returns>
        public STORAGE_QOS_CONTROL_Request ConstructSqosRequest(
            ...
            ulong lowerLatencyIncrement = 0)
        {
            STORAGE_QOS_CONTROL_Request sqosRequest = new STORAGE_QOS_CONTROL_Request()
            {
            ...
            sqosRequest.InitiatorNameLength = (ushort)sqosRequest.InitiatorName.Length;
            sqosRequest.InitiatorNodeNameLength = (ushort)sqosRequest.InitiatorNodeName.Length;
            if (sqosRequest.InitiatorNameLength != 0)
            {
                sqosRequest.InitiatorNameOffset =
                    (ushort)(TypeMarshal.ToBytes<STORAGE_QOS_CONTROL_Request>(sqosRequest).Length - sqosRequest.InitiatorNameLength - sqosRequest.InitiatorNodeNameLength);
            }

            if (sqosRequest.InitiatorNodeNameLength != 0)
            {
                sqosRequest.InitiatorNodeNameOffset = (ushort)(sqosRequest.InitiatorNameOffset + sqosRequest.InitiatorNameLength);
            }
