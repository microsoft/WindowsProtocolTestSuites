...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite
{
    public partial class FsInfoTestCases : PtfTestClassBase
    {
        ...
        private void FsInfo_Query_FileFsSectorSizeInformation_OutputValue_Common(FileType fileType)
        {
            ...
            BaseTestSite.Log.Add(LogEntryKind.Comment, "FileSystemEffectivePhysicalBytesPerSectorForAtomicity MUST be greater than or equal to LogicalBytesPerSector, MUST be a power of two, MUST be less than or equal to Volume.SystemPageSize");
