...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite
{
    public partial class AlternateDataStreamTestCases : PtfTestClassBase
    {
        ...
        private void AlternateDataStream_Set_FileValidDataLengthInformation(FileType fileType)
        {
            ...
            //Step 5: Set FILE_VALIDDATALENGTH_INFORMATION
            BaseTestSite.Log.Add(LogEntryKind.TestStep, "5. SetFileInformation with FileInfoClass.FILE_VALIDDATALENGTH_INFORMATION.");
