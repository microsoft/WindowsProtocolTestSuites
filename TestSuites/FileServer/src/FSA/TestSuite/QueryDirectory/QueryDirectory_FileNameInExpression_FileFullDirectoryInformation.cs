...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite.TraditionalTestCases.QueryDirectory
{
    public partial class QueryDirectoryTestCases : PtfTestClassBase
    {
        ...
        [Description("Verify the Query Directory response with FileFullDirectoryInformation from the server for search patterns described in [MS-FSA] 2.1.4.")]
        public void BVT_QueryDirectoryBySearchPattern_FileFullDirectoryInformation_AsteriskWildCard()
        {
            ...
            Site.Assert.AreEqual(12, fileInformation.Length, "The returned Buffer should contain twelve entries of FileFullDirectoryInformation.");
        ...
        public void BVT_QueryDirectoryBySearchPattern_FileFullDirectoryInformation_AsteriskInStringWildCard()
        {
            ...
            Site.Assert.AreEqual(4, fileInformation.Length, "The returned Buffer should contain four entries of FileFullDirectoryInformation.");
            filesCount = fileNames.Intersect(GetListFileInformation(fileInformation)).ToList().Count();
        ...
        public void BVT_QueryDirectoryBySearchPattern_FileFullDirectoryInformation_DOS_DOT_WildCard()
        {
            ...
            Site.Assert.AreEqual(2, fileInformation.Length, "The returned Buffer should contain two entries of FileFullDirectoryInformation.");
            filesCount = fileNames.Intersect(GetListFileInformation(fileInformation)).ToList().Count();
        ...
        public void BVT_QueryDirectoryBySearchPattern_FileFullDirectoryInformation_DOS_DOT_QuestionMark_WildCard()
        {
            ...
            Site.Assert.AreEqual(3, fileInformation.Length, "The returned Buffer should contain three entries of FileFullDirectoryInformation.");
            filesCount = fileNames.Intersect(GetListFileInformation(fileInformation)).ToList().Count();
