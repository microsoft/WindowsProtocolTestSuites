...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite.TraditionalTestCases.QueryDirectory
{
    public partial class QueryDirectoryTestCases : PtfTestClassBase
    {
        ...
        [TestCategory(TestCategories.QueryDirectory)]
        [TestCategory(TestCategories.NonSmb)]
        [Description("Verify the Query Directory response with FileIdFullDirectoryInformation from the server for search pattern DOS_STAR described in [MS-FSA] 2.1.4.")]
        ...
        [TestCategory(TestCategories.QueryDirectory)]
        [TestCategory(TestCategories.NonSmb)]
        [Description("Verify the Query Directory response with FileIdFullDirectoryInformation from the server for search pattern DOS_QM described in [MS-FSA] 2.1.4.")]
        public void BVT_QueryDirectoryBySearchPattern_FileIdFullDirectoryInformation_DOS_QM_WildCard()
        {
            var fileInformation = new List<FileIdFullDirectoryInformation>();
            int expectedFilesReturnedLength = 2;
            var fileNames = new List<string> { "Fine", "File", "Bile", "Fille", "Nine" };
        ...
        [TestCategory(TestCategories.QueryDirectory)]
        [TestCategory(TestCategories.NonSmb)]
        [Description("Verify the Query Directory response with FileIdFullDirectoryInformation from the server for search pattern DOS_DOT described in [MS-FSA] 2.1.4.")]
