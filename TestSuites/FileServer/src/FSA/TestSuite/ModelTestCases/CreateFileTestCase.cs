...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite {
    ...
    public partial class CreateFileTestCase : PtfTestClassBase {
        ...
        public void CreateFileTestCaseS36() {
            ...
            this.Manager.AddReturn(GetOSInfoInfo, null, temp30);
            this.Manager.Comment("reaching state \'S96\'");
            int temp37 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(CreateFileTestCase.GetOSInfoInfo, null, new GetOSInfoDelegate1(this.CreateFileTestCaseS36GetOSInfoChecker)), new ExpectedReturn(CreateFileTestCase.GetOSInfoInfo, null, new GetOSInfoDelegate1(this.CreateFileTestCaseS36GetOSInfoChecker1)));
            if ((temp37 == 0)) {
                ...
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, temp31, "isFlagValue of CheckIsR507Implemented, state S156");
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(this.Manager, this.Make<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(new string[] {
                                ...
                                Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PrivilegeSet.SeRestorePrivilege,
                                false,
                                false}), temp32, "securityContext of GetSystemConfig, state S206");
                ...
                this.Manager.Comment("checking step \'return CreateFile/INVALID_PARAMETER\'");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus>(this.Manager, Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus.INVALID_PARAMETER, temp33, "return of CreateFile, state S238");
            ...
            if ((temp37 == 1)) {
                ...
                bool temp34;
                this.Manager.Comment("executing step \'call CheckIsR507Implemented(out _)\'");
                this.IFSAAdapterInstance.CheckIsR507Implemented(out temp34);
                this.Manager.Comment("reaching state \'S157\'");
                this.Manager.Comment("checking step \'return CheckIsR507Implemented/[out False]\'");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, temp34, "isFlagValue of CheckIsR507Implemented, state S157");
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(this.Manager, this.Make<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(new string[] {
                                ...
                                Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PrivilegeSet.SeRestorePrivilege,
                                false,
                                false}), temp35, "securityContext of GetSystemConfig, state S207");
                ...
                this.Manager.Comment("checking step \'return CreateFile/SUCCESS\'");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus)(0)), temp36, "return of CreateFile, state S239");
...
;
        ...
        private void CreateFileTestCaseS36GetOSInfoChecker(Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType platformType) {
            this.Manager.Comment("checking step \'return GetOSInfo/[out Windows]\'");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType)(0)), platformType, "platformType of GetOSInfo, state S96");
        }
        
        private void CreateFileTestCaseS36GetOSInfoChecker1(Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType platformType) {
            this.Manager.Comment("checking step \'return GetOSInfo/[out NoneWindows]\'");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType)(1)), platformType, "platformType of GetOSInfo, state S96");
        }
        #endregion
