...
namespace Microsoft.Protocols.TestSuites.FileSharing.FSA.TestSuite {
    ...
    public partial class OpenFileTestCase : PtfTestClassBase {
        ...
        public void OpenFileTestCaseS34() {
            ...
            this.Manager.AddReturn(GetOSInfoInfo, null, temp28);
            this.Manager.Comment("reaching state \'S110\'");
            int temp35 = this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(OpenFileTestCase.GetOSInfoInfo, null, new GetOSInfoDelegate1(this.OpenFileTestCaseS34GetOSInfoChecker)), new ExpectedReturn(OpenFileTestCase.GetOSInfoInfo, null, new GetOSInfoDelegate1(this.OpenFileTestCaseS34GetOSInfoChecker1)));
            if ((temp35 == 0)) {
                ...
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, temp29, "isFlagValue of CheckIsR507Implemented, state S173");
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(this.Manager, this.Make<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(new string[] {
                                ...
                                Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PrivilegeSet.SeRestorePrivilege,
                                false,
                                false}), temp30, "securityContext of GetSystemConfig, state S220");
                ...
                this.Manager.Comment("checking step \'return OpenExistingFile/INVALID_PARAMETER\'");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus>(this.Manager, Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus.INVALID_PARAMETER, temp31, "return of OpenExistingFile, state S224");
            ...
            if ((temp35 == 1)) {
                ...
                bool temp32;
                this.Manager.Comment("executing step \'call CheckIsR507Implemented(out _)\'");
                this.IFSAAdapterInstance.CheckIsR507Implemented(out temp32);
                this.Manager.Comment("reaching state \'S174\'");
                this.Manager.Comment("checking step \'return CheckIsR507Implemented/[out False]\'");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, temp32, "isFlagValue of CheckIsR507Implemented, state S174");
                this.Manager.Comment("reaching state \'S206\'");
                Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext temp33;
                this.Manager.Comment("executing step \'call GetSystemConfig(out _)\'");
                this.IFSAAdapterInstance.GetSystemConfig(out temp33);
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(this.Manager, this.Make<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.SSecurityContext>(new string[] {
                                ...
                                Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PrivilegeSet.SeRestorePrivilege,
                                false,
                                false}), temp33, "securityContext of GetSystemConfig, state S221");
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.MessageStatus)(0)), temp34, "return of OpenExistingFile, state S225");
...
;
        ...
        private void OpenFileTestCaseS34GetOSInfoChecker(Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType platformType) {
            this.Manager.Comment("checking step \'return GetOSInfo/[out Windows]\'");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType)(0)), platformType, "platformType of GetOSInfo, state S110");
        }
        
        private void OpenFileTestCaseS34GetOSInfoChecker1(Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType platformType) {
            this.Manager.Comment("checking step \'return GetOSInfo/[out NoneWindows]\'");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType>(this.Manager, ((Microsoft.Protocols.TestSuites.FileSharing.FSA.Adapter.PlatformType)(1)), platformType, "platformType of GetOSInfo, state S110");
        }
        #endregion
