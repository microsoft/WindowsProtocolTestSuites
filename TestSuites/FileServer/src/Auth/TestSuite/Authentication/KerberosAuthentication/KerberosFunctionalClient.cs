...
{
    public class KerberosFunctionalClient : KerberosClient
    {
        ...
        {
            testSite.Log.Add(LogEntryKind.Debug, "Setup {0} transport connection with KDC({1}:{2}).", transportType, kdcAddress, kdcPort);
            base.Connect();
        }
        ...
        public KerberosAsResponse ExpectAsResponse()
        {
            ...
            if (responsePdu is KerberosKrbError)
            {
                ...
                this.testSite.Log.Add(LogEntryKind.Debug, "ERROR CODE: {0}", error.ErrorCode.ToString());
            }
            ...
            this.testSite.Log.Add(LogEntryKind.Debug, "Receive AS response.");
        ...
        public KerberosKrbError ExpectKrbError()
        {
            ...
            testSite.Log.Add(LogEntryKind.Debug, "Receive Kerberos Error.");
            return krbError;
        }
