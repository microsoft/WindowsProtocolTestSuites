...
echo "EXECUTING [ChangeUserAcctPasswordLDAP.ps1]." |Out-File $logFile -Append
...
trap
{
	...
	Throw "EXECUTE [ChangeUserAcctPasswordLDAP.ps1] FAILED. For more information, please see $logFile."
}
...
# Ending script
#-------------------------------------------------------------------------------------#
echo "EXECUTE [ChangeUserAcctPasswordLDAP.ps1] FINISHED." | Out-File $logFile -Append
if($NewUser -eq $null) {
  return $false
}
return $true