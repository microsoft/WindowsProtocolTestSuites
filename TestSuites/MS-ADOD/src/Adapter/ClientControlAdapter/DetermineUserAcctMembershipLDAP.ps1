...
## File:           DetermineUserAcctMembershipLDAP.ps1
...
echo "EXECUTING [DetermineUserAcctMembershipLDAP.ps1]." |Out-File $logFile -Append
...
# Ending script
#-------------------------------------------------------------------------------------#
echo "EXECUTE [DetermineUserAcctMembershipLDAP.ps1] FINISHED." | Out-File $logFile -Append
