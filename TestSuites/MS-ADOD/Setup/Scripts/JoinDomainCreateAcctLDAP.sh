...
{
cat<<HELP
JoinDomainCreateAcctLDAP -- To trigger the client join domain by creating an account using LDAP.

USAGE: JoinDomainCreateAcctLDAP fulldomainname username password
HELP
echo false
exit 1
}
