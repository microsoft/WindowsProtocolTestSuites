...
* [License Information](#_Toc474756890)
...
## <a name="_Toc474756890"/>License Information
...
## <a name="_Toc474756891"/>Further Assistance
...
Additionally the installation process also adds following folders and files to the Driver Computer at %systemdrive%\MicrosoftProtocolTests\MS-ADOD\OD-Endpoint\Infrastructure\src\, which contains the Message Analyzer Library project that test suite will referenced.

|  **File or Folder**|  **Description**| 
| -------------| ------------- |
| MessageAnalyzerLibrary|  * Message Analyzer Library source code used by Test Suite.| 
