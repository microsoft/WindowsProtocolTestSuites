...
Function Config-Environment
{
    ...
    Write-ConfigLog "Domain" -ForegroundColor Yellow
    Write-ConfigLog $param["domain"] -ForegroundColor Yellow
    Write-ConfigLog $param["username"] -ForegroundColor Yellow
    Write-ConfigLog $param["password"] -ForegroundColor Yellow
    ...
    Write-ConfigLog "Promote domain controller" -ForegroundColor Yellow
