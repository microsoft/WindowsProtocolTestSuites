...
{
    /// <summary>
    /// Base class of FR-IQA(Full reference based image quality assessment).
    /// </summary>
    public abstract class FRIQAIndexBase
    {
        ...
        /// <param name="distorted">Distorted bitmap</param>
        /// <exception cref="ArgumentNullException">Thrown when at least one param is null</exception>
        /// <exception cref="ArgumentException">Thrown when the size of two bitmaps are invalid</exception>
    ...
    /// <summary>
    /// Store the result of the assessment of a IQA index in three components.
    /// Getting the result of a component by calling GetY, GetCb or GetCr.
    /// </summary>
    public class AssessResult
    {
        /// <summary>
        /// Storing the result on Luma component
        /// </summary>
        private double? luma;
        /// <summary>
        /// Storing the result on Cb component
        /// </summary>
        private double? cb;
        /// <summary>
        /// Storing the result on Cr component
        /// </summary>
        private double? cr;

        /// <summary>
        /// Assess result on Luma component.
        /// </summary>
        public double Luma
        {
            get
