...
$returnValue = .\Run-TaskWithPSRemoting.ps1 $PtfProp_SUTName $PtfProp_RDPConnectWithNegotiationApproachFullScreen_Task $PtfProp_SUTUserName $PtfProp_SUTUserPassword
return $returnValue
