...
# and the client should use Direct Approach with CredSSP as the security protocol and use an invalid username.
...
$returnValue = ./Run-CredentialManagerWithPSRemoting.ps1 $PtfProp_SUTName $PtfProp_RDPConnectWithDirectCredSSPInvalidAccount_Task $PtfProp_SUTUserName
return $returnValue
