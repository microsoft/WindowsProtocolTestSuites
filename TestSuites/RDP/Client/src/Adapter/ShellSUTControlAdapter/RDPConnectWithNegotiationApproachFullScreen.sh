...
#
# cmd="DISPLAY=:10.0 nohup xfreerdp /t:RDPClient /f /rfx /u:$PTFProp_RDP_ServerUserName /p:'$PTFProp_RDP_ServerUserPassword' /v:$PTFProp_RDP_ServerDomain:$PTFProp_RDP_ServerPort > /dev/null 2>&1 &"
...
# RDPConnectWithNegotiationApproachFullScreen(string caseName)
