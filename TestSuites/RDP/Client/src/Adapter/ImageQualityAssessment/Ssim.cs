...
namespace Microsoft.Protocols.TestSuites.Rdp.ImageQualityAssessment
{
    ...
    public class Ssim : FRIQAIndexBase
    {
        ...
        /// </summary>
        protected const double C1 = 0.01 * 0.01 * 255 * 255;
        /// <summary>
        /// The constant C2 in algorithm
        /// </summary>
        protected const double C2 = 0.03 * 0.03 * 255 * 255;
        /// <summary>
        /// The constant C3 in algorithm
        /// </summary>
        protected const double C3 = C2 * 0.5;
        ...
        /// </summary>
        public const int MinHeight = 256;
        ...
        protected override void CheckException(SKBitmap reference, SKBitmap distorted)
        {
            if (reference == null)
            {
        ...
        public override AssessResult Assess(SKBitmap reference, SKBitmap distorted, UseComponent component)
        {
            ...
            SsimParameters ssimParams = new SsimParameters(WindowWidth, WindowHeight, C1, C2, C3);
    ...
    internal class SsimAuxiliaries
    {
        ...
        /// <summary>
        /// Return a new 2d-array which has the same size with specified 2d-array src and where the value in [x,y] is the sum of all elements 
    ...
    internal sealed class SsimCalculator
    {
        ...
        /// <summary>
        /// Calculate Mean SSIM by pixels of two images 
        /// </summary>
        ...
        /// <summary>
        /// Calculate local SSIM by pixels of two images in the specified window
        /// </summary>
