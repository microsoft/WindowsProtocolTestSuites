...
$cmdError = Invoke-Command -HostName $ptfprop_SUTName -UserName $ptfprop_SUTUserName -ScriptBlock $scriptblock -ArgumentList ($PtfProp_SUTName, $PtfProp_SUTUserName, $PtfProp_SUTUserPassword, $PtfProp_TriggerSingleTouchPositionEvent_Task) 2>&1 | out-file "./error.txt"
