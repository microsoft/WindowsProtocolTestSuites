...
cmd /c schtasks /run /s $PtfProp_SUTName /U $PtfProp_SUTUserName /P $PtfProp_SUTUserPassword /TN $PtfProp_TriggerContinuousTouchEvent_Task 2>&1 | out-file ".\error.txt"
