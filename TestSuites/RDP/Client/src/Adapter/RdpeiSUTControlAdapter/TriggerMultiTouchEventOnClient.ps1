...
$cmdError = Invoke-Command -HostName $PtfProp_SUTName -UserName $PtfProp_SUTUserName -ScriptBlock $scriptblock -ArgumentList ($PtfProp_SUTName, $PtfProp_SUTUserName, $PtfProp_SUTUserPassword, $PtfProp_TriggerMultiTouchEvent_Task) 2>&1 | Out-File "./TriggerMultiTouchEventOnClient.txt"

$cmdError = Get-Content "./TriggerMultiTouchEventOnClient.txt"
if ($cmdError -ne $null) {
