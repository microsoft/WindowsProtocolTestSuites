...
namespace Microsoft.Protocols.TestSuites.Rdpegfx
{
    public partial class RdpegfxTestSuite : RdpTestClassBase
    {
        ...
        [TestCategory("RDP8.0")]
        [TestCategory("RDPEGFX")]
        [Description("This test case is used to test create surface, solid fill, map to window and delete surface command.")]
        public void RDPEGFX_SurfaceToScreen_PositiveTest_Window()
        {
            uint fid;
            ...
            // Map surface to Output
            this.TestSite.Log.Add(LogEntryKind.Comment, "Map surface to output.");
            fid = this.rdpegfxAdapter.MapSurfaceToWindow(surf.Id, RdpegfxTestUtility.surfPos.x, RdpegfxTestUtility.surfPos.y);
            this.rdpegfxAdapter.ExpectFrameAck(fid);
