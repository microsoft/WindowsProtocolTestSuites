...
[Viewing RDP Output Data with Message Analyzer (Deprecated)](#viewing-rdp-output-data-with-message-analyzer-deprecated)

-    [Install and Configure Microsoft Message Analyzer (Deprecated)](#install-and-configure-microsoft-message-analyzer)

-    [Capturing RDP Traffic with Microsoft Message Analyzer (Deprecated)](#capturing-rdp-traffic-with-microsoft-message-analyzer)
...
&emsp;&emsp;[Viewing RDP Output Data with Message Analyzer (Deprecated)](#viewing-rdp-output-data-with-message-analyzer-deprecated)
...
**Microsoft® Message Analyzer** (MMA) **--- DEPRECATED.** Microsoft
Message Analyzer was retired on November 25, 2019 and has been removed
from all public-facing Microsoft download sites. MMA is no longer
available for download and is no longer supported. For network traffic
analysis and ETL file inspection, consider using alternative tools such
as **Microsoft Network Monitor**, **Wireshark**, or **netsh trace**.

Previously, MMA could be used with this Test Suite to analyze ETL files
generated by test cases (via the **NetworkCapture** **Properties** on
the **PTF** tab) and to capture messages from the
**Protocol-Test-Suite** message provider. For more information about
Automatic Network Capturing, see the [Getting Started Guide for the
Protocol Test
...
# Viewing RDP Output Data with Message Analyzer (Deprecated)

![](./image/RDP_ClientUserGuide/media/image3.png)Important

**Microsoft Message Analyzer (MMA) has been deprecated.** MMA was
retired by Microsoft on November 25, 2019 and has been removed from all
public-facing download sites. It is no longer available for download and
is no longer supported. For network traffic analysis and debugging test
case results, consider using alternative tools such as **Microsoft
Network Monitor**, **Wireshark**, or **netsh trace**.
...
Test Results](#reviewing-the-test-results).
