...
$returnValue = .\Run-TaskWithPSRemoting.ps1 $PtfPropSUTName $PtfPropRDPConnectWithNegotiationApproachFullScreen_Task $PtfPropSUTUserName $PtfPropSUTUserPassword
return $returnValue
