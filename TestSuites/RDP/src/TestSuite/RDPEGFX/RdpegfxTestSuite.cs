...
namespace Microsoft.Protocols.TestSuites.Rdpegfx
{
    ...
    public class RdpegfxTestUtility
    {
        ...
        public static ushort MaxBmpWidth = 32766;  // TDI number is 0xffff, it is actual test limit due to max supported Virtual Destop Width in RDP8
        public static ushort MaxBmpHeight = 32766; // TDI number is 0xffff, it is actual test limit due to max supported Virtual Destop Height in RDP8
