...
namespace Microsoft.Protocols.TestSuites.Rdpbcgr
{
    ...
    {        
        ...
        {
            Site.Assert.AreEqual<ushort>(0x0400, (ushort)redirectionPacket.Flags, "In Server Redirection Packet , the Flags field MUST be set to SEC_REDIRECTION_PKT (0x0400).");
