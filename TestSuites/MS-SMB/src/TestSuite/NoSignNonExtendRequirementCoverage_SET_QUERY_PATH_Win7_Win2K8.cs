...
;
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_PATH_Win7_Win2K8S0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent(  new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S111, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_PATH_Win7_Win2K8S0CreateResponseChecker1(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent(  new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S112, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_PATH_Win7_Win2K8S4CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent(  new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S113, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_PATH_Win7_Win2K8S6CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent(  new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S114, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_PATH_Win7_Win2K8S8CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent(  new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S115, field selection Rep");
