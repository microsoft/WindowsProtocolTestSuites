...
namespace GeneratedTests {
    ...
    public partial class NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel : PtfTestClassBase {
        
        public NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel() {
        ...
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker1)));
                        if ((temp4 == 0)) {
                            this.Manager.Comment("reaching state \'S28\'");
                            goto label3;
                        }
                        if ((temp4 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS29();
                            goto label3;
                        }
                        if ((temp4 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS29();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker1)));
                    label3:
;
                    }
                    else {
                    ...
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS29() {
            ...
            int temp3 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0TreeConnectResponseChecker)));
            if ((temp3 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS36();
                goto label2;
            }
            if ((temp3 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS36();
            ...
            if ((temp3 == 6)) {
                ...
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS40();
                goto label2;
            }
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0TreeConnectResponseChecker)));
        label2:
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS36() {
            this.Manager.Comment("reaching state \'S36\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS40() {
            this.Manager.Comment("reaching state \'S40\'");
            this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.CreateRequestInfo, null, new CreateRequestDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0CreateRequestChecker)));
            this.Manager.Comment("reaching state \'S41\'");
            int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0CreateResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker4)));
            if ((temp2 == 0)) {
                ...
                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.Trans2QueryFsInfoResponseInfo, null, new Trans2QueryFsInfoResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0Trans2QueryFsInfoResponseChecker)));
                if ((temp1 == 0)) {
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0CreateRequestChecker() {
            this.Manager.Comment("checking step \'return CreateRequest\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0Trans2QueryFsInfoResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0ErrorResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8")]
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp7 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedSessionSetupResponseChecker1)));
                        if ((temp7 == 0)) {
                            this.Manager.Comment("reaching state \'S31\'");
                            goto label5;
                        }
                        if ((temp7 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS30();
                            goto label5;
                        }
                        if ((temp7 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS30();
...
;
                    ...
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,True,5,{CapNtSmbs,CapDf" +
                    "s,CapInfoLevelPassThru},Success)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(2,NetworkSessionExpired)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,False,Succe" +
                    "ss)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS30() {
            ...
            int temp6 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2TreeConnectResponseChecker)));
            if ((temp6 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS38();
                goto label4;
            }
            if ((temp6 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS38();
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,False)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS38() {
            this.Manager.Comment("reaching state \'S38\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidSmb, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.StatusBadNetWorkName, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8_InvalidLevelS2NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,True,Succes" +
                    "s)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
