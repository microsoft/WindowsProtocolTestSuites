...
namespace GeneratedTests {
    ...
    public partial class NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2 : PtfTestClassBase {
        
        public NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0NegotiateResponseChecker))) != -1)) {
                        ...
                        this.ISmbAdapterInstance.SessionSetupNonUnicodeRequest(((Microsoft.Protocol.TestSuites.Smb.AccountType)(0)), 2, 0, 0, false, new List<Microsoft.Protocol.TestSuites.Smb.Capabilities> { Microsoft.Protocol.TestSuites.Smb.Capabilities.CapNtSmbs, Microsoft.Protocol.TestSuites.Smb.Capabilities.CapExtendedSecurity }, false, false, true);
...
;
        ...
        private void NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S14() {
            this.Manager.Comment("reaching state \'S14\'");
        }
        
        private void NoSignRequirementCoverage_UnicodeNotUseTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
