...
namespace GeneratedTests {
    ...
    public partial class NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8 : PtfTestClassBase {
        
        public NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8() {
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S14() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker))) != -1)) {
                this.Manager.Comment("reaching state \'S17\'");
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker2(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker3(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
