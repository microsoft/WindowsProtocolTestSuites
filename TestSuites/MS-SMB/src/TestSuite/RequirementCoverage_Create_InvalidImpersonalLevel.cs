...
namespace GeneratedTests {
    ...
    public partial class RequirementCoverage_Create_InvalidImpersonalLevel : PtfTestClassBase {
        
        public RequirementCoverage_Create_InvalidImpersonalLevel() {
        ...
        public virtual void RequirementCoverage_Create_InvalidImpersonalLevelS0() {
            this.Manager.BeginTest("RequirementCoverage_Create_InvalidImpersonalLevelS0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0NegotiateResponseChecker))) != -1)) {
                        ...
                        if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0SessionSetupResponseChecker))) != -1)) {
                            ...
                            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0TreeConnectResponseChecker))) != -1)) {
                                ...
                                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker1)));
                                if ((temp1 == 0)) {
                                ...
                                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker1)));
                            label0:
;
                            }
                            else {
                                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0TreeConnectResponseChecker)));
                            }
                        }
                        else {
                            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0SessionSetupResponseChecker)));
                        }
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void RequirementCoverage_Create_InvalidImpersonalLevelS0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8R2")]
        public virtual void RequirementCoverage_Create_InvalidImpersonalLevelS2() {
            this.Manager.BeginTest("RequirementCoverage_Create_InvalidImpersonalLevelS2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2NegotiateResponseChecker))) != -1)) {
                        ...
                        if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2SessionSetupResponseChecker))) != -1)) {
                            ...
                            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2TreeConnectResponseChecker))) != -1)) {
                                ...
                                int temp3 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2ErrorResponseChecker1)));
                                if ((temp3 == 0)) {
...
;
                                ...
                                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2TreeConnectResponseChecker)));
                            }
                        }
                        else {
                            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2SessionSetupResponseChecker)));
                        }
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8R2)\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2NegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NegotiateResponse(1,False,True,5,{CapNtSmbs,CapExtendedSecur" +
                    "ity,CapDfs,CapInfoLevelPassThru},Success)\'");
            try {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event SessionSetupResponse(2,1,1,True,False,Success)\'");
            try {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,BadImpersonationLevel)\'");
            try {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS2ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S58");
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8R2")]
        public virtual void RequirementCoverage_Create_InvalidImpersonalLevelS4() {
            this.Manager.BeginTest("RequirementCoverage_Create_InvalidImpersonalLevelS4");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4NegotiateResponseChecker))) != -1)) {
                        ...
                        if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4SessionSetupResponseChecker))) != -1)) {
                            ...
                            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4TreeConnectResponseChecker))) != -1)) {
                                ...
                                int temp5 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4ErrorResponseChecker1)));
                                if ((temp5 == 0)) {
...
;
                                ...
                                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4TreeConnectResponseChecker)));
                            }
                        }
                        else {
                            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4SessionSetupResponseChecker)));
                        }
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_Create_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_Create_InvalidImpersonalLevelS4SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8R2)\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4NegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NegotiateResponse(1,False,True,5,{CapNtSmbs,CapExtendedSecur" +
                    "ity,CapDfs,CapInfoLevelPassThru},Success)\'");
            try {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event SessionSetupResponse(2,1,1,True,False,Success)\'");
            try {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_Create_InvalidImpersonalLevelS4ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S59");
