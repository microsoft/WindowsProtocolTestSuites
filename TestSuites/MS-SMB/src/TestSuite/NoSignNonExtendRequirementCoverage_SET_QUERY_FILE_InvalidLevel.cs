...
namespace GeneratedTests {
    ...
    public partial class NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel : PtfTestClassBase {
        
        public NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel() {
        ...
        public virtual void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0() {
            this.Manager.BeginTest("NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker3)));
                        if ((temp2 == 0)) {
                            NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS28();
                            goto label1;
                        }
                        if ((temp2 == 1)) {
                            NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS28();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker3)));
                    label1:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS28() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0TreeConnectResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0CreateResponseChecker))) != -1)) {
                    ...
                    int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker3)));
                    if ((temp1 == 0)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS46();
                        goto label0;
                    }
                    if ((temp1 == 1)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS46();
                    ...
                    if ((temp1 == 2)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS47();
                        goto label0;
                    }
                    if ((temp1 == 3)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS47();
                    ...
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker3)));
                label0:
;
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0CreateResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS46() {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS47() {
            this.Manager.Comment("reaching state \'S47\'");
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0ErrorTrans2QueryFileInfoResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker2(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS0NonExtendedSessionSetupResponseChecker3(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8R2")]
        public virtual void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2() {
            this.Manager.BeginTest("NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp5 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker3)));
                        if ((temp5 == 0)) {
                            NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS29();
                            goto label3;
                        }
                        if ((temp5 == 1)) {
                            NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS29();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8R2)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,False,5,{CapNtSmbs,CapD" +
                    "fs,CapInfoLevelPassThru},Success)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,True,True,Succes" +
                    "s)\'");
            try {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS29() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2TreeConnectResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2CreateResponseChecker))) != -1)) {
                    ...
                    int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.ErrorTrans2QueryFileInfoResponseInfo, null, new ErrorTrans2QueryFileInfoResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker3)));
                    if ((temp4 == 0)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS48();
                        goto label2;
                    }
                    if ((temp4 == 1)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS48();
                    ...
                    if ((temp4 == 2)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS49();
                        goto label2;
                    }
                    if ((temp4 == 3)) {
                        NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS49();
...
;
                    ...
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2CreateResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,True,Disk,Success,False,False,True" +
                    ")\'");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event CreateResponse(4,1,1,0,False,{FileCreated,FileDoesNotExist}," +
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
            this.Manager.Comment("checking step \'event ErrorTrans2QueryFileInfoResponse(5,NotSupported,True)\'");
            try {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS48() {
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS49() {
            this.Manager.Comment("reaching state \'S49\'");
        }
        
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
            this.Manager.Comment("checking step \'event ErrorTrans2QueryFileInfoResponse(5,NotSupported,False)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorTrans2QueryFileInfoResponse, state S45");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NotSupported, messageStatus, "messageStatus of ErrorTrans2QueryFileInfoResponse, state S45");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
            this.Manager.Comment("checking step \'event ErrorTrans2QueryFileInfoResponse(5,NetworkSessionExpired,Tru" +
                    "e)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorTrans2QueryFileInfoResponse, state S45");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2ErrorTrans2QueryFileInfoResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS2073Implemented) {
            this.Manager.Comment("checking step \'event ErrorTrans2QueryFileInfoResponse(5,NetworkSessionExpired,Fal" +
                    "se)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorTrans2QueryFileInfoResponse, state S45");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTrans2QueryFileInfoResponse, state S45");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,False,True,Succe" +
                    "ss)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker2(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,True,False,Succe" +
                    "ss)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
        ...
        private void NoSignNonExtendRequirementCoverage_SET_QUERY_FILE_InvalidLevelS2NonExtendedSessionSetupResponseChecker3(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,False,False,Succ" +
                    "ess)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
