...
namespace GeneratedTests {
    ...
    public partial class NonExtendRequirementCoverage_Printer_Win7_Win2K8 : PtfTestClassBase {
        
        public NonExtendRequirementCoverage_Printer_Win7_Win2K8() {
        ...
        public virtual void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_Printer_Win7_Win2K8S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1)));
                        if ((temp1 == 0)) {
                            NonExtendRequirementCoverage_Printer_Win7_Win2K8S14();
                            goto label0;
                        }
                        if ((temp1 == 1)) {
                            NonExtendRequirementCoverage_Printer_Win7_Win2K8S14();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1)));
                    label0:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S14() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker))) != -1)) {
                this.Manager.Comment("reaching state \'S17\'");
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Printer_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker)));
            }
        }
        
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NonExtendRequirementCoverage_Printer_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
