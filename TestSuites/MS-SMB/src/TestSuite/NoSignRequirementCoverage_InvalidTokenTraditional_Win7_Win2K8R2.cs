...
namespace GeneratedTests {
    ...
    public partial class NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2 : PtfTestClassBase {
        
        public NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2() {
        ...
        public virtual void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0() {
            this.Manager.BeginTest("NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                        if ((temp2 == 0)) {
                            NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S28();
                            goto label1;
                        }
                        if ((temp2 == 1)) {
                            NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S28();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                    label1:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S28() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker))) != -1)) {
                this.Manager.Comment("reaching state \'S34\'");
                this.Manager.Comment("executing step \'call CreateRequest(4,1,1,3,FileOpenIf,0,\"Dir1\",Disk,False,False,T" +
                        "rue,True)\'");
                this.ISmbAdapterInstance.CreateRequest(4, 1, 1, 3, Microsoft.Protocol.TestSuites.Smb.CreateDisposition.FileOpenIf, 0, "Dir1", ((Microsoft.Protocol.TestSuites.Smb.ShareType)(0)), false, false, true, true);
                this.Manager.Comment("reaching state \'S36\'");
                this.Manager.Comment("checking step \'return CreateRequest\'");
                this.Manager.Comment("reaching state \'S38\'");
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0CreateResponseChecker))) != -1)) {
                    this.Manager.Comment("reaching state \'S40\'");
                    this.Manager.Comment("executing step \'call Trans2FindFirst2RequestInvalidDirectoryToken(5,1,1,False,Tru" +
                            "e,SmbInfoStandard,-1,True,True)\'");
                    this.ISmbAdapterInstance.Trans2FindFirst2RequestInvalidDirectoryToken(5, 1, 1, false, true, ((Microsoft.Protocol.TestSuites.Smb.InformationLevel)(0)), -1, true, true);
                    this.Manager.Comment("reaching state \'S42\'");
                    this.Manager.Comment("checking step \'return Trans2FindFirst2RequestInvalidDirectoryToken\'");
                    NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S44();
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0CreateResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isDirectoryZero, "isDirectoryZero of CreateResponse, state S38");
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S44() {
            this.Manager.Comment("reaching state \'S44\'");
            int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker1)), new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker2)));
            if ((temp1 == 0)) {
                NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S45();
                goto label0;
            }
            if ((temp1 == 1)) {
                NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S45();
...
;
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(5,InvalidParameter)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorResponse, state S44");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidParameter, messageStatus, "messageStatus of ErrorResponse, state S44");
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S45() {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(5,ObjectNameNotFound)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorResponse, state S44");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.ObjectNameNotFound, messageStatus, "messageStatus of ErrorResponse, state S44");
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8R2")]
        public virtual void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2() {
            this.Manager.BeginTest("NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SessionSetupResponseChecker1)));
                        if ((temp4 == 0)) {
                            NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S29();
                            goto label2;
                        }
                        if ((temp4 == 1)) {
                            NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S29();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8R2)\'");
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2NegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NegotiateResponse(1,False,False,5,{CapNtSmbs,CapExtendedSecu" +
                    "rity,CapDfs,CapInfoLevelPassThru},Success)\'");
            try {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event SessionSetupResponse(2,1,0,False,False,Success)\'");
            try {
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S29() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2TreeConnectResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2CreateResponseChecker))) != -1)) {
                    this.Manager.Comment("reaching state \'S41\'");
                    this.Manager.Comment("executing step \'call Trans2FindFirst2RequestInvalidFileToken(5,1,1,False,True,Smb" +
                            "InfoStandard,-1,True,True)\'");
                    this.ISmbAdapterInstance.Trans2FindFirst2RequestInvalidFileToken(5, 1, 1, false, true, ((Microsoft.Protocol.TestSuites.Smb.InformationLevel)(0)), -1, true, true);
                    this.Manager.Comment("reaching state \'S43\'");
                    this.Manager.Comment("checking step \'return Trans2FindFirst2RequestInvalidFileToken\'");
                    NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S44();
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2CreateResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,True,Disk,Success,False,False,True" +
                    ")\'");
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event CreateResponse(4,1,1,0,False,{FileCreated,FileDoesNotExist}," +
                    "True,True,False,True,True,Success)\'");
            try {
                ...
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isDirectoryZero, "isDirectoryZero of CreateResponse, state S39");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isByteCountZero, "isByteCountZero of CreateResponse, state S39");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isNoStream, "isNoStream of CreateResponse, state S39");
        ...
        private void NoSignRequirementCoverage_InvalidTokenTraditional_Win7_Win2K8R2S2SessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event SessionSetupResponse(2,1,0,False,True,Success)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of SessionSetupResponse, state S27");
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, sessionId, "sessionId of SessionSetupResponse, state S27");
