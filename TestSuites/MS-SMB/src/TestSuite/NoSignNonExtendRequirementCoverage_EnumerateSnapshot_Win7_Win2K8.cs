...
namespace GeneratedTests {
    ...
    public partial class NoSignNonExtendRequirementCoverage_EnumerateSnapshot_Win7_Win2K8 : PtfTestClassBase {
        ...
        protected override void TestInitialize() {
            ...
            this.ISmbAdapterInstance.FsctlSrvEnumSnapshotsResponse += ISmbAdapterInstance_FsctlSrvEnumSnapshotsResponse;
        ...
        private void ISmbAdapterInstance_FsctlSrvEnumSnapshotsResponse(int messageId, int sessionId, int treeId, bool isSigned, MessageStatus messageStatus, IntegerCompare NumberOfSnapShotsCompared)
        {
            this.Manager.AddEvent(FsctlSrvEnumSnapshotsResponseInfo, this.ISmbAdapterInstance, new object[] { messageId, sessionId, treeId, isSigned, messageStatus, NumberOfSnapShotsCompared });
        }
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_EnumerateSnapshot_Win7_Win2K8S2CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.CreateAction>(this.Manager, new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S91, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_EnumerateSnapshot_Win7_Win2K8S4CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.CreateAction>(this.Manager, new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S92, field selection Rep");
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_EnumerateSnapshot_Win7_Win2K8S6CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.CreateAction>(this.Manager, new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileOpened, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileExists }, createAction, "createAction of CreateResponse, state S93, field selection Rep");
