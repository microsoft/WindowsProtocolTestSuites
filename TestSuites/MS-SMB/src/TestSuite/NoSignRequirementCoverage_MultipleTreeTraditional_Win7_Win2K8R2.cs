...
namespace GeneratedTests {
    ...
    public partial class NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2 : PtfTestClassBase {
        
        public NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2() {
        ...
        public virtual void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0() {
            this.Manager.BeginTest("NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                        if ((temp1 == 0)) {
                            NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S14();
                            goto label0;
                        }
                        if ((temp1 == 1)) {
                            NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S14();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                    label0:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 0, securitySignatureValue, "securitySignatureValue of SessionSetupResponse, state S13");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isSigned, "isSigned of SessionSetupResponse, state S13");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isGuestAccount, "isGuestAccount of SessionSetupResponse, state S13");
        ...
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S14() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker))) != -1)) {
                this.Manager.Comment("reaching state \'S17\'");
                this.Manager.Comment("executing step \'call TreeMultipleConnectRequest(4,1,False,True,True,\"Share1\",Disk" +
                        ",False)\'");
                this.ISmbAdapterInstance.TreeMultipleConnectRequest(4, 1, false, true, true, "Share1", ((Microsoft.Protocol.TestSuites.Smb.ShareType)(0)), false);
                this.Manager.Comment("reaching state \'S18\'");
                this.Manager.Comment("checking step \'return TreeMultipleConnectRequest\'");
                this.Manager.Comment("reaching state \'S19\'");
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker1))) != -1)) {
                    this.Manager.Comment("reaching state \'S20\'");
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker1)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker1(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(4,1,2,True,Disk,Success,False,False,True" +
                    ")\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 1, sessionId, "sessionId of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, treeId, "treeId of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isSecuritySignatureZero, "isSecuritySignatureZero of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.ShareType>(this.Manager, ((Microsoft.Protocol.TestSuites.Smb.ShareType)(0)), shareType, "shareType of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, ((Microsoft.Protocol.TestSuites.Smb.MessageStatus)(0)), messageStatus, "messageStatus of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isSigned, "isSigned of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isInDfs, "isInDfs of TreeConnectResponse, state S19");
                TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isSupportExtSignature, "isSupportExtSignature of TreeConnectResponse, state S19");
            }
            catch (TransactionFailedException ) {
                this.Manager.Comment("This step would have covered MS-SMB_R8565");
                throw;
            }
            this.Manager.Checkpoint("MS-SMB_R8565");
        }
        
        private void NoSignRequirementCoverage_MultipleTreeTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
