...
namespace GeneratedTests {
    ...
    public partial class NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2 : PtfTestClassBase {
        
        public NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2() {
        ...
        public virtual void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0() {
            this.Manager.BeginTest("NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                        if ((temp1 == 0)) {
                            NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S14();
                            goto label0;
                        }
                        if ((temp1 == 1)) {
                            NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S14();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker)), new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1)));
                    label0:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S14() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0CreateResponseChecker))) != -1)) {
                    this.Manager.Comment("reaching state \'S20\'");
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.CreateResponseInfo, null, new CreateResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0CreateResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0TreeConnectResponseChecker)));
            }
        }
        ...
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            ...
            try {
                ...
                CollectionAssert.AreEquivalent( new List<Microsoft.Protocol.TestSuites.Smb.CreateAction> { Microsoft.Protocol.TestSuites.Smb.CreateAction.FileCreated, Microsoft.Protocol.TestSuites.Smb.CreateAction.FileDoesNotExist }, createAction, "createAction of CreateResponse, state S19, field selection Rep");
        ...
        private void NoSignRequirementCoverage_CreateNewfolderTraditional_Win7_Win2K8R2S0SessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
