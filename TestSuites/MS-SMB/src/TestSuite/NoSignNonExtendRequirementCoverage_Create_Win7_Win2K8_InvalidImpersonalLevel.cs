...
namespace GeneratedTests {
    ...
    public partial class NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel : PtfTestClassBase {
        
        public NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel() {
        ...
        public virtual void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0() {
            this.Manager.BeginTest("NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp3 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker3)));
                        if ((temp3 == 0)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS28();
                            goto label2;
                        }
                        if ((temp3 == 1)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS28();
                        ...
                        if ((temp3 == 2)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS29();
                            goto label2;
                        }
                        if ((temp3 == 3)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS29();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker3)));
                    label2:
;
                    }
                    else {
                    ...
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0SmbConnectionResponseChecker)));
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS28() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0TreeConnectResponseChecker))) != -1)) {
                ...
                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker1)));
                if ((temp1 == 0)) {
...
;
                ...
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker2(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS29() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0TreeConnectResponseChecker1))) != -1)) {
                ...
                int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker3)));
                if ((temp2 == 0)) {
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0TreeConnectResponseChecker1(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,True,Disk,Success,False,False,True" +
                    ")\'");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,BadImpersonationLevel)\'");
            try {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S44");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS0NonExtendedSessionSetupResponseChecker3(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8")]
        public virtual void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2() {
            this.Manager.BeginTest("NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp6 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker1)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker2)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker3)));
                        if ((temp6 == 0)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS30();
                            goto label4;
                        }
                        if ((temp6 == 1)) {
                            NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS30();
...
;
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,False,5,{CapNtSmbs,CapD" +
                    "fs,CapInfoLevelPassThru},Success)\'");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,False,False,Succ" +
                    "ess)\'");
            try {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS30() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2TreeConnectResponseChecker))) != -1)) {
                ...
                int temp5 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ErrorResponseChecker)), new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ErrorResponseChecker1)));
                if ((temp5 == 0)) {
...
;
                ...
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2TreeConnectResponseChecker)));
            }
        }
        
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,True,Disk,Success,False,False,True" +
                    ")\'");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S45");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,True,False,Succe" +
                    "ss)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
        ...
        private void NoSignNonExtendRequirementCoverage_Create_Win7_Win2K8_InvalidImpersonalLevelS2NonExtendedSessionSetupResponseChecker2(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,0,False,False,True,Succe" +
                    "ss)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S27");
