...
namespace GeneratedTests {
    ...
    public partial class NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8 : PtfTestClassBase {
        
        public NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8() {
        ...
        {
            this.Manager.AddEvent(Trans2QueryFsInfoResponseInfo, this.IServerSetupAdapterInstance, new object[] { messageId, sessionId, treeId, isSigned, messageStatus });
        }
        ...
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1)));
                        if ((temp4 == 0)) {
                            this.Manager.Comment("reaching state \'S56\'");
                            goto label3;
                        }
                        if ((temp4 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S57();
                            goto label3;
                        }
                        if ((temp4 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S57();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1)));
                    label3:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S57() {
            ...
            int temp3 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0TreeConnectResponseChecker)));
            if ((temp3 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S72();
                goto label2;
            }
            if ((temp3 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S72();
            ...
            if ((temp3 == 6)) {
                ...
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S80();
                goto label2;
            }
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0TreeConnectResponseChecker)));
        label2:
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S72() {
            this.Manager.Comment("reaching state \'S72\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S80() {
            this.Manager.Comment("reaching state \'S80\'");
            this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.CreateRequestInfo, null, new CreateRequestDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0CreateRequestChecker)));
            this.Manager.Comment("reaching state \'S83\'");
            int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.CreateResponseInfo, null, new CreateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0CreateResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker4)));
            if ((temp2 == 0)) {
                ...
                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.Trans2QueryFsInfoResponseInfo, null, new Trans2QueryFsInfoResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0Trans2QueryFsInfoResponseChecker)));
                if ((temp1 == 0)) {
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0CreateRequestChecker() {
            this.Manager.Comment("checking step \'return CreateRequest\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0Trans2QueryFsInfoResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0ErrorResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8")]
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp9 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedSessionSetupResponseChecker1)));
                        if ((temp9 == 0)) {
                            this.Manager.Comment("reaching state \'S59\'");
                            goto label7;
                        }
                        if ((temp9 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S58();
                            goto label7;
                        }
                        if ((temp9 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S58();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,True,5,{CapNtSmbs,CapDf" +
                    "s,CapInfoLevelPassThru},Success)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(2,NetworkSessionExpired)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,False,Succe" +
                    "ss)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S58() {
            ...
            int temp8 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2TreeConnectResponseChecker)));
            if ((temp8 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S75();
                goto label6;
            }
            if ((temp8 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S75();
            ...
            if ((temp8 == 6)) {
                ...
                int temp7 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.CreateResponseInfo, null, new CreateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2CreateResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker4)));
                if ((temp7 == 0)) {
                    ...
                    int temp6 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.Trans2QueryFsInfoResponseInfo, null, new Trans2QueryFsInfoResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2Trans2QueryFsInfoResponseChecker)));
                    if ((temp6 == 0)) {
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,False)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S75() {
            this.Manager.Comment("reaching state \'S75\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S69");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S69");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.StatusBadNetWorkName, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S69");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S69");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S69");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S69");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S69");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S69");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidSmb, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S69");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S69");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(5,NetworkSessionExpired)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(5,NotSupported)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 5, messageId, "messageId of ErrorResponse, state S103");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2Trans2QueryFsInfoResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event Trans2QueryFsInfoResponse(5,1,1,True,Success)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2ErrorResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,BadImpersonationLevel)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S84");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S2NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,True,Succes" +
                    "s)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S53");
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8")]
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp12 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedSessionSetupResponseChecker1)));
                        if ((temp12 == 0)) {
                            this.Manager.Comment("reaching state \'S61\'");
                            goto label9;
                        }
                        if ((temp12 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S60();
                            goto label9;
                        }
                        if ((temp12 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S60();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,True,5,{CapNtSmbs,CapDf" +
                    "s,CapInfoLevelPassThru},Success)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(2,NetworkSessionExpired)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,False,Succe" +
                    "ss)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S60() {
            ...
            int temp11 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4TreeConnectResponseChecker)));
            if ((temp11 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S77();
                goto label8;
            }
            if ((temp11 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S77();
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,False)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S77() {
            this.Manager.Comment("reaching state \'S77\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S70");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S70");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.StatusBadNetWorkName, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S70");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S70");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S70");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S70");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S70");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S70");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidSmb, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S70");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S70");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S4NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,True,Succes" +
                    "s)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S54");
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8")]
        public virtual void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp17 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedSessionSetupResponseChecker1)));
                        if ((temp17 == 0)) {
                            this.Manager.Comment("reaching state \'S63\'");
                            goto label13;
                        }
                        if ((temp17 == 1)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S62();
                            goto label13;
                        }
                        if ((temp17 == 2)) {
                            NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S62();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedNegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedNegotiateResponse(1,False,True,5,{CapNtSmbs,CapDf" +
                    "s,CapInfoLevelPassThru},Success)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(2,NetworkSessionExpired)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,False,Succe" +
                    "ss)\'");
            try {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S62() {
            ...
            int temp16 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker4)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker5)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6TreeConnectResponseChecker)));
            if ((temp16 == 0)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S78();
                goto label12;
            }
            if ((temp16 == 1)) {
                NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S78();
            ...
            if ((temp16 == 6)) {
                ...
                int temp15 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.CreateResponseInfo, null, new CreateResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6CreateResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker3)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker4)));
                if ((temp15 == 0)) {
                    ...
                    int temp14 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker1)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker2)), new ExpectedEvent(NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8.Trans2SetFsInfoResponseInfo, null, new Trans2SetFsInfoResponseDelegate1(this.NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6Trans2SetFsInfoResponseChecker)));
                    if ((temp14 == 0)) {
...
;
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,False)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S78() {
            this.Manager.Comment("reaching state \'S78\'");
        }
        
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S71");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidSmb, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S71");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S71");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S71");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.StatusBadNetWorkName, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S71");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S71");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(5,NetworkSessionExpired)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6Trans2SetFsInfoResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,BadImpersonationLevel)\'");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6ErrorResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(4,NetworkSessionExpired)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 4, messageId, "messageId of ErrorResponse, state S85");
        ...
        private void NonExtendRequirementCoverage_SET_QUERY_FS_Win7_Win2K8S6NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NonExtendedSessionSetupResponse(2,1,1,True,False,True,Succes" +
                    "s)\'");
            try {
                TestManagerHelpers.AssertAreEqual<int>(this.Manager, 2, messageId, "messageId of NonExtendedSessionSetupResponse, state S55");
