...
namespace GeneratedTests {
    ...
    public partial class RequirementCoverage_SET_QUERY_FS_InvalidLevel : PtfTestClassBase {
        
        public RequirementCoverage_SET_QUERY_FS_InvalidLevel() {
        ...
        public virtual void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0() {
            this.Manager.BeginTest("RequirementCoverage_SET_QUERY_FS_InvalidLevelS0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp4 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SessionSetupResponseChecker)));
                        if ((temp4 == 0)) {
                        ...
                        if ((temp4 == 1)) {
                            ...
                            int temp3 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0TreeConnectResponseChecker)));
                            if ((temp3 == 0)) {
                                RequirementCoverage_SET_QUERY_FS_InvalidLevelS36();
                                goto label2;
                            }
                            if ((temp3 == 1)) {
                                RequirementCoverage_SET_QUERY_FS_InvalidLevelS36();
                            ...
                            if ((temp3 == 6)) {
                                ...
                                RequirementCoverage_SET_QUERY_FS_InvalidLevelS40();
                                goto label2;
                            }
                            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker1)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker2)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker3)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker4)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker5)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0TreeConnectResponseChecker)));
                        label2:
;
                            goto label3;
                        }
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SessionSetupResponseChecker)));
                    label3:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0NegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS36() {
            this.Manager.Comment("reaching state \'S36\'");
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS40() {
            this.Manager.Comment("reaching state \'S40\'");
            this.Manager.ExpectReturn(this.QuiescenceTimeout, true, new ExpectedReturn(RequirementCoverage_SET_QUERY_FS_InvalidLevel.CreateRequestInfo, null, new CreateRequestDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0CreateRequestChecker)));
            this.Manager.Comment("reaching state \'S41\'");
            int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0CreateResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker3)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker4)));
            if ((temp2 == 0)) {
                ...
                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker1)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker2)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.Trans2QueryFsInfoResponseInfo, null, new Trans2QueryFsInfoResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0Trans2QueryFsInfoResponseChecker)));
                if ((temp1 == 0)) {
                ...
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker1)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker2)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.Trans2QueryFsInfoResponseInfo, null, new Trans2QueryFsInfoResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0Trans2QueryFsInfoResponseChecker)));
            label0:
;
                goto label1;
            }
            ...
            this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.CreateResponseInfo, null, new CreateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0CreateResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker3)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker4)));
        label1:
;
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0CreateRequestChecker() {
            this.Manager.Comment("checking step \'return CreateRequest\'");
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0CreateResponseChecker(int messageId, int sessionId, int treeId, int fid, bool isSigned, List<Microsoft.Protocol.TestSuites.Smb.CreateAction> createAction, bool isFileIdZero, bool isVolumeGuidZero, bool isDirectoryZero, bool isByteCountZero, bool isNoStream, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0Trans2QueryFsInfoResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS0ErrorResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(), Microsoft.VisualStudio.TestTools.UnitTesting.TestCategory("Win7_Win2K8R2")]
        public virtual void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2() {
            this.Manager.BeginTest("RequirementCoverage_SET_QUERY_FS_InvalidLevelS2");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2NegotiateResponseChecker))) != -1)) {
                        ...
                        int temp7 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SessionSetupResponseChecker)));
                        if ((temp7 == 0)) {
                        ...
                        if ((temp7 == 1)) {
                            ...
                            int temp6 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker1)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker2)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker3)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker4)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorTreeConnectResponseInfo, null, new ErrorTreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker5)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2TreeConnectResponseChecker)));
                            if ((temp6 == 0)) {
                                RequirementCoverage_SET_QUERY_FS_InvalidLevelS38();
                                goto label4;
                            }
                            if ((temp6 == 1)) {
                                RequirementCoverage_SET_QUERY_FS_InvalidLevelS38();
...
;
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorResponseChecker)), new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SessionSetupResponseInfo, null, new SessionSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SessionSetupResponseChecker)));
                    label5:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.NegotiateResponseInfo, null, new NegotiateResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2NegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(RequirementCoverage_SET_QUERY_FS_InvalidLevel.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
            this.Manager.Comment("checking step \'event SmbConnectionResponse(Win7,Win2K8R2)\'");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
            this.Manager.Comment("checking step \'event ServerSetupResponse(1,True,True,True,True,True)\'");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2NegotiateResponseChecker(int messageId, bool isSignatureRequired, bool isSignatureEnabled, int dialectIndex, List<Microsoft.Protocol.TestSuites.Smb.Capabilities> serverCapabilities, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event NegotiateResponse(1,False,True,5,{CapNtSmbs,CapExtendedSecur" +
                    "ity,CapDfs,CapInfoLevelPassThru},Success)\'");
            try {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event ErrorResponse(2,NetworkSessionExpired)\'");
            try {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2SessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
            this.Manager.Comment("checking step \'event SessionSetupResponse(2,1,1,True,False,Success)\'");
            try {
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,False)\'");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS38() {
            this.Manager.Comment("reaching state \'S38\'");
        }
        
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker1(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker2(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,InvalidSmb,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.InvalidSmb, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, true, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker3(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,True)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker4(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,NetworkSessionExpired,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.NetworkSessionExpired, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2ErrorTreeConnectResponseChecker5(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isRS357Implemented) {
            this.Manager.Comment("checking step \'event ErrorTreeConnectResponse(3,StatusBadNetWorkName,False)\'");
            TestManagerHelpers.AssertAreEqual<int>(this.Manager, 3, messageId, "messageId of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<Microsoft.Protocol.TestSuites.Smb.MessageStatus>(this.Manager, Microsoft.Protocol.TestSuites.Smb.MessageStatus.StatusBadNetWorkName, messageStatus, "messageStatus of ErrorTreeConnectResponse, state S35");
            TestManagerHelpers.AssertAreEqual<bool>(this.Manager, false, isRS357Implemented, "isRS357Implemented of ErrorTreeConnectResponse, state S35");
        ...
        private void RequirementCoverage_SET_QUERY_FS_InvalidLevelS2TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
            this.Manager.Comment("checking step \'event TreeConnectResponse(3,1,1,False,Disk,Success,True,False,True" +
                    ")\'");
