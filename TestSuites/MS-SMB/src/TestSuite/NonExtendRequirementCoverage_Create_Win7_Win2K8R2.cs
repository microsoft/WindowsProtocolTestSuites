...
namespace GeneratedTests {
    ...
    public partial class NonExtendRequirementCoverage_Create_Win7_Win2K8R2 : PtfTestClassBase {
        
        public NonExtendRequirementCoverage_Create_Win7_Win2K8R2() {
        ...
        public virtual void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0() {
            this.Manager.BeginTest("NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0");
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0SmbConnectionResponseChecker))) != -1)) {
                ...
                if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ServerSetupResponseChecker))) != -1)) {
                    ...
                    if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedNegotiateResponseChecker))) != -1)) {
                        ...
                        int temp2 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker1)));
                        if ((temp2 == 0)) {
                            NonExtendRequirementCoverage_Create_Win7_Win2K8R2S14();
                            goto label1;
                        }
                        if ((temp2 == 1)) {
                            NonExtendRequirementCoverage_Create_Win7_Win2K8R2S14();
                        ...
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedSessionSetupResponseInfo, null, new NonExtendedSessionSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker1)));
                    label1:
;
                    }
                    else {
                        this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NonExtendedNegotiateResponseInfo, null, new NonExtendedNegotiateResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedNegotiateResponseChecker)));
                    }
                }
                else {
                    this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.ServerSetupResponseInfo, null, new ServerSetupResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ServerSetupResponseChecker)));
                }
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.SmbConnectionResponseInfo, null, new SmbConnectionResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0SmbConnectionResponseChecker)));
            }
            this.Manager.EndTest();
        }
        
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0SmbConnectionResponseChecker(Microsoft.Protocol.TestSuites.Smb.Platform clientPlatform, Microsoft.Protocol.TestSuites.Smb.Platform sutPlatform) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ServerSetupResponseChecker(int totalBytesWritten, bool isSupportInfoLevelPassthru, bool isSupportNtSmb, bool isRapServerActive, bool isSupportResumeKey, bool isSupportCopyChunk) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S14() {
            ...
            if ((this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0TreeConnectResponseChecker))) != -1)) {
                ...
                int temp1 = this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NtTransactCreateResponseInfo, null, new NtTransactCreateResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NtTransactCreateResponseChecker)));
                if ((temp1 == 0)) {
                ...
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.ErrorResponseInfo, null, new ErrorResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ErrorResponseChecker)), new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.NtTransactCreateResponseInfo, null, new NtTransactCreateResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NtTransactCreateResponseChecker)));
            label0:
;
            }
            else {
                this.Manager.CheckObservationTimeout(false, new ExpectedEvent(NonExtendRequirementCoverage_Create_Win7_Win2K8R2.TreeConnectResponseInfo, null, new TreeConnectResponseDelegate1(this.NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0TreeConnectResponseChecker)));
            }
        }
        
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0TreeConnectResponseChecker(int messageId, int sessionId, int treeId, bool isSecuritySignatureZero, Microsoft.Protocol.TestSuites.Smb.ShareType shareType, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus, bool isSigned, bool isInDfs, bool isSupportExtSignature) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0ErrorResponseChecker(int messageId, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NtTransactCreateResponseChecker(int messageId, int sessionId, int treeId, bool isSigned, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
        ...
        private void NonExtendRequirementCoverage_Create_Win7_Win2K8R2S0NonExtendedSessionSetupResponseChecker1(int messageId, int sessionId, int securitySignatureValue, bool isSigned, bool isGuestAccount, bool isRS2322Implemented, Microsoft.Protocol.TestSuites.Smb.MessageStatus messageStatus) {
