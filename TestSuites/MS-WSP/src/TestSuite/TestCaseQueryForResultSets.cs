...
namespace Microsoft.Protocols.TestSuites.WspTS
{
    ...
    public partial class TestCaseQueryForResultSets : WspModelTestBase
    {
        ...
        public virtual void TestCaseQueryForResultSetsS0()
        {
            ...
            if ((temp0 == 0))
            {
                ...
                this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForResultSets.CPMGetRowsOutResponseInfo, null, new CPMGetRowsOutResponseDelegate1(this.TestCaseQueryForResultSetsS0CPMGetRowsOutResponseChecker)));
            ...
            if ((temp0 == 1))
            {
                ...
                this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForResultSets.CPMGetRowsOutResponseInfo, null, new CPMGetRowsOutResponseDelegate1(this.TestCaseQueryForResultSetsS0CPMGetRowsOutResponseChecker1)));
        ...
        private void TestCaseQueryForResultSetsS0CPMGetRowsOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseQueryForResultSetsS0CPMGetRowsOutResponseChecker1(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMGetRowsOutResponse(returnCode1)\'");
