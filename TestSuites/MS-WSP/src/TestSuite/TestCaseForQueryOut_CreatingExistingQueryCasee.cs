...
namespace Microsoft.Protocols.TestSuites.WspTS
{
    ...
    public partial class TestCaseForQueryOut_CreatingExistingQueryCasee : WspModelTestBase
    {
        public TestCaseForQueryOut_CreatingExistingQueryCasee()
        {
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("MS-WSP_R592, MS-WSP_R599, MS-WSP_R647, MS-WSP_R651, MS-WSP_R653, MS-WSP_R654, MS-" +
            "WSP_R655, MS-WSP_R657, MS-WSP_R658, MS-WSP_R662, MS-WSP_R663")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CPMCreateQuery")]
        public virtual void TestCaseForQueryOut_CreatingExistingQueryCaseeS0()
        {
            this.Manager.BeginTest("TestCaseForQueryOut_CreatingExistingQueryCaseeS0");
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseForQueryOut_CreatingExistingQueryCasee.CPMConnectOutResponseInfo, null, new CPMConnectOutResponseDelegate1(this.TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMConnectOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseForQueryOut_CreatingExistingQueryCasee.CPMCreateQueryOutResponseInfo, null, new CPMCreateQueryOutResponseDelegate1(this.TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMCreateQueryOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseForQueryOut_CreatingExistingQueryCasee.CPMCreateQueryOutResponseInfo, null, new CPMCreateQueryOutResponseDelegate1(this.TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMCreateQueryOutResponseChecker1)));
            this.Manager.Comment("reaching state \'S9\'");
            this.Manager.EndTest();
        }

        private void TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMConnectOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMCreateQueryOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseForQueryOut_CreatingExistingQueryCaseeS0CPMCreateQueryOutResponseChecker1(uint errorCode)
        {
            ...
            this.Manager.Assert((errorCode == 3221225485), string.Format("expected \'3221225485\', actual \'{0}\' (errorCode of CPMCreateQueryOutResponse, stat" +
                        "e S8)", errorCode));
            this.Manager.Checkpoint("MS-WSP_R658");
