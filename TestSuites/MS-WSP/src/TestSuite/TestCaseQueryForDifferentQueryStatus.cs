...
namespace Microsoft.Protocols.TestSuites.WspTS
{
    ...
    public partial class TestCaseQueryForDifferentQueryStatus : WspModelTestBase
    {
        public TestCaseQueryForDifferentQueryStatus()
        {
        ...
        #region Variables
        private IVariable<uint> returnCode5;
        #endregion
        ...
        protected override void TestInitialize()
        {
            ...
            this.returnCode5 = this.Manager.CreateVariable<uint>("returnCode5");
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute(@"MS-WSP_R592, MS-WSP_R599, MS-WSP_R647, MS-WSP_R651, MS-WSP_R653, MS-WSP_R654, MS-WSP_R655, MS-WSP_R657, MS-WSP_R672, MS-WSP_R674, MS-WSP_R679, MS-WSP_R680, MS-WSP_R682, MS-WSP_R692, MS-WSP_R693, MS-WSP_R695, MS-WSP_R702, MS-WSP_R751, MS-WSP_R791, MS-WSP_R793")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("CPMCreateQuery")]
        public virtual void TestCaseQueryForDifferentQueryStatusS0()
        {
            this.Manager.BeginTest("TestCaseQueryForDifferentQueryStatusS0");
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMConnectOutResponseInfo, null, new CPMConnectOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMConnectOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMCreateQueryOutResponseInfo, null, new CPMCreateQueryOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMCreateQueryOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMGetQueryStatusOutResponseInfo, null, new CPMGetQueryStatusOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMGetQueryStatusOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMGetQueryStatusExOutResponseInfo, null, new CPMGetQueryStatusExOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMGetQueryStatusExOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMRatioFinishedOutResponseInfo, null, new CPMRatioFinishedOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMRatioFinishedOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMSendNotifyOutResponseInfo, null, new CPMSendNotifyOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMSendNotifyOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseQueryForDifferentQueryStatus.CPMFreeCursorOutResponseInfo, null, new CPMFreeCursorOutResponseDelegate1(this.TestCaseQueryForDifferentQueryStatusS0CPMFreeCursorOutResponseChecker)));
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMConnectOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMCreateQueryOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMGetQueryStatusOutResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMGetQueryStatusOutResponse(0)\'");
            this.Manager.Assert((errorCode == 0), string.Format("expected \'0\', actual \'{0}\' (errorCode of CPMGetQueryStatusOutResponse, state S8)", errorCode));
            this.Manager.Checkpoint("MS-WSP_R592");
            this.Manager.Checkpoint("MS-WSP_R599");
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMGetQueryStatusExOutResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMGetQueryStatusExOutResponse(0)\'");
            this.Manager.Assert((errorCode == 0), string.Format("expected \'0\', actual \'{0}\' (errorCode of CPMGetQueryStatusExOutResponse, state S1" +
                        "1)", errorCode));
            this.Manager.Checkpoint("MS-WSP_R592");
            this.Manager.Checkpoint("MS-WSP_R599");
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMRatioFinishedOutResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMRatioFinishedOutResponse(0)\'");
            this.Manager.Assert((errorCode == 0), string.Format("expected \'0\', actual \'{0}\' (errorCode of CPMRatioFinishedOutResponse, state S14)", errorCode));
            this.Manager.Checkpoint("MS-WSP_R592");
            this.Manager.Checkpoint("MS-WSP_R599");
        ...
        private void TestCaseQueryForDifferentQueryStatusS0CPMSendNotifyOutResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMSendNotifyOutResponse(returnCode)\'");
            this.returnCode5.Value = errorCode;
            this.Manager.Checkpoint("MS-WSP_R592");
            this.Manager.Checkpoint("MS-WSP_R599");
            this.Manager.Checkpoint("MS-WSP_R751");
        }

        private void TestCaseQueryForDifferentQueryStatusS0CPMFreeCursorOutResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMFreeCursorOutResponse(0)\'");
            this.Manager.Assert((errorCode == 0), string.Format("expected \'0\', actual \'{0}\' (errorCode of CPMFreeCursorOutResponse, state S20)", errorCode));
            this.Manager.Checkpoint("MS-WSP_R592");
            this.Manager.Checkpoint("MS-WSP_R599");
