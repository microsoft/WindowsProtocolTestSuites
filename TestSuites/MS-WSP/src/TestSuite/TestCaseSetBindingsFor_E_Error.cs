...
namespace Microsoft.Protocols.TestSuites.WspTS
{
    ...
    public partial class TestCaseSetBindingsFor_E_Error : WspModelTestBase
    {
        public TestCaseSetBindingsFor_E_Error()
        {
        ...
        {
            this.Manager.BeginTest("TestCaseSetBindingsFor_E_ErrorS0");
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseSetBindingsFor_E_Error.CPMConnectOutResponseInfo, null, new CPMConnectOutResponseDelegate1(this.TestCaseSetBindingsFor_E_ErrorS0CPMConnectOutResponseChecker)));
            ...
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseSetBindingsFor_E_Error.CPMCreateQueryOutResponseInfo, null, new CPMCreateQueryOutResponseDelegate1(this.TestCaseSetBindingsFor_E_ErrorS0CPMCreateQueryOutResponseChecker)));
            this.Manager.Comment("reaching state \'S6\'");
            this.Manager.Comment("executing step \'call CPMSetBindingsIn(True,False)\'");
            this.IWspAdapterInstance.CPMSetBindingsIn(true, false);
            this.Manager.Comment("reaching state \'S7\'");
            this.Manager.Comment("checking step \'return CPMSetBindingsIn\'");
            this.Manager.Comment("reaching state \'S8\'");
            this.Manager.ExpectEvent(this.QuiescenceTimeout, true, new ExpectedEvent(TestCaseSetBindingsFor_E_Error.CPMSetBindingsInResponseInfo, null, new CPMSetBindingsInResponseDelegate1(this.TestCaseSetBindingsFor_E_ErrorS0CPMSetBindingsInResponseChecker)));
            this.Manager.Comment("reaching state \'S9\'");
            this.Manager.EndTest();
        }

        private void TestCaseSetBindingsFor_E_ErrorS0CPMConnectOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseSetBindingsFor_E_ErrorS0CPMCreateQueryOutResponseChecker(uint errorCode)
        {
        ...
        private void TestCaseSetBindingsFor_E_ErrorS0CPMSetBindingsInResponseChecker(uint errorCode)
        {
            this.Manager.Comment("checking step \'event CPMSetBindingsInResponse(v0)\'");
