...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.WSP.Adapter
{
    ...
    public class MessageValidator
    {
            ...
            uint messageStatus, uint numberOfCatSet)
        {
            ...
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 67, "For any arbitrary value of the" +
                " 'paddingPropSet' field, server is returning success.");
            // For arbitary value in  'Padding1'field 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 78, "For any arbitrary value of " +
                "the 'Padding1' field, server is returning success.");
            // For arbitary value in 'Padding2' field 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 85, "For any arbitrary value of " +
                "the 'Padding2' field, server is returning success.");
            // For arbitary value in padding fields of 'Padding1' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 104, "For any arbitrary value of " +
                "'_padding_cc' field, the server is returning success.");
            // For arbitary value in  '_padding_lcid' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 111, "For any arbitrary value of " +
                "'_padding_lcid' field, the server is returning success.");
            // For arbitary value in padding fields of '_paNode' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 116, "For any arbitrary value of " +
                "'_paNode' field,server is returning success.");
            // For arbitary value in 'padding_lcid' field 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 123, "For any arbitrary value of " +
                "'_padding_lcid' field of the CPropertyRestriction" +
                " structure, server is returning success.");
            // For arbitary value in padding fields of 'Padding1' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 131, "For any arbitrary " +
                "value of '_padding'" +
                "  field of the CScopeRestriction structure, " +
                "server is returning success.");
            // For arbitary value in padding fields of 'Padding1' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 143, "For any arbitrary value" +
                " of '_padding'  field of the CVectorRestriction " +
                "structure, server is returning success.");
            // For arbitary value in padding fields of 'Padding1' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 204, "For any arbitrary value of" +
                " '_padding' field of the RANGEBOUNDARY" +
                " structure, server is returning success.");
            // For arbitary value in 'Padding' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 215, "For any arbitrary value of " +
                "'padding' field of the  CAggregSpec structure, " +
                "server is returning success.");
            // For arbitary value in field 'padding' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 228, "For any arbitrary value of " +
                "'padding' field of the  CInGroupSortAggregSet " +
                "structure, server is returning success.");
            // For arbitary value in padding fields of 'paddingPropSpec' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 274, "For any arbitrary value" +
                " of 'paddingPropSpec'  field of the CPidMapper " +
                "structure, server response is success.");
            // For arbitary value in padding fields in array of CFullPropSpec 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 278, "For any arbitrary " +
                "value of Padding bytes  in the array of" +
                " CFullPropSpec structures, server response is success.");
            // For arbitary value in padding fields  in the array 
            // of CColumnGroup the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 283, "For any arbitrary value of" +
                " Padding bytes in the array of CColumnGroup " +
                "structures, server response is success.");
            // For arbitary value in padding fields of CSort Structures 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 332, "For any value of Padding" +
                " bytes in the array of CSort structures, " +
                "server response is success.");
            // For arbitary value in padding fields of '_padding' 
            // the server response is success.Hence validated
            site.CaptureRequirementIfAreEqual<uint>((uint)WspErrorCode.SUCCESS,
                messageStatus, 166, "For any arbitrary value " +
                "of '_padding' field of the CInternalPropertyRestriction" +
                " structure, server is returning success.");

            // for any value of this field the server response is success
            site.CaptureRequirementIfAreEqual<uint>
                (0x00000000, messageStatus, 446,
                "For any arbitrary value of 'paddingCColumnSetPresent'" +
                " field of the  CPMCreateQueryIn message," +
                "server response is success.");

            // for any value of this field the server response is success
            site.CaptureRequirementIfAreEqual<uint>
                (0x00000000, messageStatus, 454,
                "For any arbitrary value of 'paddingCRestrictionPresent'" +
                " field of the CPMCreateQueryIn message," +
                "server response is success.");

            // for any value of this field the server response is success
            site.CaptureRequirementIfAreEqual<uint>
                (0x00000000, messageStatus, 462,
                "For any arbitrary value of 'paddingCSortSetPresent'" +
                " field of CPMCreateQueryIn message," +
                "server response is success.");

            // for any value of this field the server response is success
            site.CaptureRequirementIfAreEqual<uint>
                (0x00000000, messageStatus, 470,
                "For any arbitrary value of " +
                "'paddingCCategorizationSetPresent' field" +
                " of the  CPMCreateQueryIn message ," +
                "server response is success.");
