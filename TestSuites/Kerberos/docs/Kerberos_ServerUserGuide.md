...
| You can install Message Analyzer as an optional. It is a good tool to help you view the network traces and ETW logs which are generated by Automatic Network Capturing feature in Protocol Test Framework.| 
|        ![notice.png](./image/notice.png)Note| 
