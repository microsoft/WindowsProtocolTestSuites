...
| You can install Message Analyzer as an option. It is a useful tool that can help you view the network traces and ETW logs which could possibly be generated by Automatic Network Capturing feature in Protocol Test Framework.| 
|        ![notice.png](./image/notice.png)Note| 
