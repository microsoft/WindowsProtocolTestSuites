...
## File:           Kerberos-DC02-Postscript.ps1
...
[string]$VMName      = "Kerberos-OSS-DC02"
[string]$TrustVMName = "Kerberos-OSS-DC01"
...
{
    # Create forest trust
    Write-Info.ps1 "Creating forest trust" -ForegroundColor Yellow
    GetVmParameters.ps1 -VMName $TrustVMName -RefParamArray ([ref]$TrustVMParamArray)
