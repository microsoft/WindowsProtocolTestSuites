...
- [MS-XCA Test Suite User Guide](#ms-xca-test-suite-user-guide)
  ...
  - [2 Test Suite Deployment](#2-test-suite-deployment)
    ...
    - [2.2 How to configure the SUT Application](#22-how-to-configure-the-sut-application)
    - [2.3 How to configure the Test Suite](#23-how-to-configure-the-test-suite)
    - [2.4 How to run the Test Suite](#24-how-to-run-the-test-suite)
      - [2.4.1 Scripts](#241-scripts)
      - [2.4.2 Protocol Test Manager (PTM) Service](#242-protocol-test-manager-ptm-service)
...
On how to use the PTM Service to run Test Suite tests, please refer to this [guide](https://github.com/microsoft/windowsprotocoltestsuites/wiki/PTMService#usage).
