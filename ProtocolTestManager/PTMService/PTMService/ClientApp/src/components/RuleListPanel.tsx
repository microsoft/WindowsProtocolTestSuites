...
export const RuleListPanel: FunctionComponent<RuleListPanelProps> = (props) => {
  ...
  const items: GroupItem[] = props.ruleGroups.map(group => { return { key: group.Name, name: group.Name, rules: group.Rules, checked: ((props.selected.find(e => e.Name == group.Name)?.Selected) != null) || [], action: props.checkedAction } })
  return (
