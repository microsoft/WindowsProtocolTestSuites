...
import { GET_DETECTION_SUMMARY_REQUEST, GET_DETECTION_SUMMARY_SUCCESS, GET_DETECTION_SUMMARY_FAILURE, TestSuiteDetectionResultActionTypes } from "../actions/DetectionResultAction";
