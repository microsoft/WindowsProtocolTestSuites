...
namespace Microsoft.Protocols.TestManager.CLI {
    ...
    internal class StringResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The capabilities filter (cfilter) parameter must be specified when a capabilities specifications file (cfile) is provided.
        /// </summary>
        internal static string MissingCapabilitiesFilterMessage {
            get {
                return ResourceManager.GetString("MissingCapabilitiesFilterMessage", resourceCulture);
            }
        }
