...
# This script is used to trigger Server to initiate a RDP connection from RDP Server, 
# and Server should use Negotiation-Based Approach to advertise the support for TLS, 
